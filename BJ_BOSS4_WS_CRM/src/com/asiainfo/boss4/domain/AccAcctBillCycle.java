...
/**
 * AccAcctBillCycle entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_ACCT_BILL_CYCLE", schema = "ZG")
@IdClass(AccAcctBillCycle.AccAcctBillCycleId.class)
...
public class AccAcctBillCycle extends BaseEntity implements java.io.Serializable {
	...
	/** default constructor */
	public AccAcctBillCycle() {
	}

	/** minimal constructor */
	public AccAcctBillCycle(Long acctId, Long soNbr, Short regionCode,
	...
	public static class AccAcctBillCycleId implements java.io.Serializable {
		...
		/** default constructor */
		public AccAcctBillCycleId() {
		}

		/** full constructor */
		public AccAcctBillCycleId(Long acctId, Long soNbr) {
			this.acctId = acctId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccAcctBillCycleId) ) return false;
			AccAcctBillCycleId castOther = (AccAcctBillCycleId) other;
