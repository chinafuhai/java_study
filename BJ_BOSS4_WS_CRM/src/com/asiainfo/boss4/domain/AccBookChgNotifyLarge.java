...
@Table(name = "ACC_BOOK_CHG_NOTIFY_LARGE", schema = "ZG")
@IdClass(AccBookChgNotifyLarge.AccBookChgNotifyLargeId.class)
//@PartitionNameForTable(operatedField = OperatedField.ACCT_ID)
@AddOnly
public class AccBookChgNotifyLarge extends BaseEntity implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotifyLarge() {
	}

	/** minimal constructor */
	public AccBookChgNotifyLarge(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotifyLarge(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotifyLargeId implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotifyLargeId() {
		}

		/** full constructor */
		public AccBookChgNotifyLargeId(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotifyLargeId) ) return false;
			AccBookChgNotifyLargeId castOther = (AccBookChgNotifyLargeId) other;
