...
@Table(name = "ACC_BOOK_CHG_NOTIFY_LARGE_INT", schema = "ZG")
@IdClass(AccBookChgNotifyLargeInt.AccBookChgNotifyLargeIntId.class)
//@PartitionNameForTable(operatedField = OperatedField.ACCT_ID)
@AddOnly
public class AccBookChgNotifyLargeInt extends BaseEntity implements java.io.Serializable {
        ...
        /** default constructor */
        public AccBookChgNotifyLargeInt() {
        }

        /** minimal constructor */
        public AccBookChgNotifyLargeInt(Long soNbr, Long acctId, Short soRegionCode,
                        String soMonth) {
                this.soNbr = soNbr;
                this.acctId = acctId;
        ...
        /** full constructor */
        public AccBookChgNotifyLargeInt(Long soNbr, Long acctId, Date createDate,
        ...
        public static class AccBookChgNotifyLargeIntId implements java.io.Serializable {
                ...
                /** default constructor */
                public AccBookChgNotifyLargeIntId() {
                }

                /** full constructor */
                public AccBookChgNotifyLargeIntId(Long soNbr, Long acctId) {
                        this.soNbr = soNbr;
                        this.acctId = acctId;
                }
                ...
                public boolean equals(Object other) {
                        if ( !(other instanceof AccBookChgNotifyLargeIntId) ) return false;
                        AccBookChgNotifyLargeIntId castOther = (AccBookChgNotifyLargeIntId) other;
