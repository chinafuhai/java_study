...
/**
 * AccUserBillCycle entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_USER_BILL_CYCLE", schema = "ZG")
@IdClass(AccUserBillCycle.AccUserBillCycleId.class)
...
public class AccUserBillCycle extends BaseEntity implements java.io.Serializable {
	...
	/** default constructor */
	public AccUserBillCycle() {
	}

	/** minimal constructor */
	public AccUserBillCycle(Long servId, Long soNbr, Short regionCode,
	...
	public static class AccUserBillCycleId implements java.io.Serializable {
		...
		/** default constructor */
		public AccUserBillCycleId() {
		}

		/** full constructor */
		public AccUserBillCycleId(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccUserBillCycleId) ) return false;
			AccUserBillCycleId castOther = (AccUserBillCycleId) other;
