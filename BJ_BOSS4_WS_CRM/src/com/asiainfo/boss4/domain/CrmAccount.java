...
/**
 * CrmAccount entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CRM_ACCOUNT", schema = "ZG")
...
public class CrmAccount extends BaseEntity implements java.io.Serializable {
	...
	/** minimal constructor */
	public CrmAccount(Long acctId) {
		this.acctId = acctId;
	}

	/** full constructor */
	public CrmAccount(Long acctId, String acctName, Byte acctClass,
			...
			String acctExtFlag, Long soNbr, String remark, String trustAcctId,
	...
	@Column(name = "BANK_ACCT", length = 128)
	...
	public void setContact(String contact) {
		// 如果CRM传入<contact>的节点值为"NULL"，则意味着需要将contact置空
		if ("NULL".equalsIgnoreCase(contact)) {
			this.contact = "";
			return;
		}
		this.contact = contact;
	...
	public void setReserved5(String reserved5) {
		// 如果CRM传入<reserved5>的节点值为"NULL"，则意味着需要将reserved5置空
		if ("NULL".equalsIgnoreCase(reserved5)) {
			this.reserved5 = "";
			return;
		}
		this.reserved5 = reserved5;
	...
	public BaseEntity modify(ServiceContext context) {
		CrmAccount oldAcct = (CrmAccount)context.getBusinessDao().getEntity(this, this.getFieldOfSelectConditionsOnCommonDaoAnnotation());
		if (!DataValiditionHelper.isEquals(oldAcct, this))
		{
			if (oldAcct == null || !(context.getTranCode().equalByTranCode(TranCode.BATCH_OPEN_ACCOUNT.getTranCode())))
