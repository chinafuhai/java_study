...
@Table(name = "CRM_GROUP_MEMBER_HIS", schema = "ZG")
@IdClass(CrmGroupMemberHis.CrmGroupMemberId.class)
@Backup(processedField = Backup.ProcessedField.P_SONBR)
public class CrmGroupMemberHis implements java.io.Serializable {
	...
	/** default constructor */
	public CrmGroupMemberHis() {
	}

	/** minimal constructor */
	public CrmGroupMemberHis(Long subServId, Byte subType, Long soId, Long acctId, Long servId,
			Date expireDate, Long soNbr, Long productId, String phoneId, Byte userSts,
			Byte memberType, Byte recStatus, Long psoNbr) {
	...
	/** full constructor */
	public CrmGroupMemberHis(Long subServId, Byte subType, Long soId, Long groupId, Long acctId,
			Long servId, Date expireDate, Long soNbr, String phoneId,
			Byte userSts, Byte memberType, Byte recStatus, Date doneDate,
			Date validDate, Integer opId, Integer orgId, Long productId, Long psoNbr) {
		this.subServId = subServId;
		this.subType = subType;
		this.soId = soId;
	...
	public static class CrmGroupMemberId implements java.io.Serializable {
		...
		@Column(name = "SO_ID", nullable = false, precision = 9, scale = 0)
		public Long getSoId() {
			return this.soId;
		}
