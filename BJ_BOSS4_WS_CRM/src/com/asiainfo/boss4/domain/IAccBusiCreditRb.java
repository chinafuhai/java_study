...
/**
 * IAccBusiCreditRb entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACC_BUSI_CREDIT_RB", schema = "INTER")
@IdClass(IAccBusiCreditRb.IAccBusiCreditRbId.class)
@Backup
@AllowUpdateZeroRow
@AllowUpdateMultiRow
public class IAccBusiCreditRb implements java.io.Serializable {
	...
	/** default constructor */
	public IAccBusiCreditRb() {
	}

	/** minimal constructor */
	public IAccBusiCreditRb(Long acctId, Integer serviceId, Long busiCredit, Long sid, Long soNbr,
	...
	public static class IAccBusiCreditRbId implements java.io.Serializable {
		...
		/** default constructor */
		public IAccBusiCreditRbId() {
		}

		/** full constructor */
		public IAccBusiCreditRbId(Long acctId, Integer serviceId, Integer creditLevel, Long servId) {
			this.acctId = acctId;
			this.serviceId = serviceId;
			this.creditLevel = creditLevel;
			this.servId = servId;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccBusiCreditRbId) ) return false;
	        IAccBusiCreditRbId castOther = (IAccBusiCreditRbId) other;
