...
@Table(name = "I_ACCOUNT_ALL", schema = "INTER")
@IdClass(IAccountAll.IAccountId.class)
...
public class IAccountAll extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccountAll(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static List<IAccountAll> queryInTimeRange(ServiceContext context, Long[] acctIds, TimeRange range) {
		if (acctIds.length == 0) return new ArrayList<IAccountAll>(0);
		Criteria crit = context.getBusinessDao().getSess().createCriteria(IAccountAll.class);
		@SuppressWarnings("unchecked")
		List<IAccountAll> list = 	crit.add(Restrictions.in("acctId", acctIds))
