...
@Table(name = "I_ACCOUNT_RB", schema = "INTER")
@IdClass(IAccountRb.IAccountId.class)
@PartitionNameForTable.RegionCode
public class IAccountRb implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccountRb(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
