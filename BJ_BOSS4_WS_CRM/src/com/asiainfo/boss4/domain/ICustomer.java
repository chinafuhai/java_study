...
@Table(name = "I_CUSTOMER", schema = "ZG")
@IdClass(ICustomer.ICustomerId.class)
...
public class ICustomer extends BaseEntity implements java.io.Serializable {
	...
	/** minimal constructor */
	public ICustomer(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public BaseEntity modify(ServiceContext context) {
		ICustomer oldCust = (ICustomer)context.getBusinessDao().getEntity(this, this.getFieldOfSelectConditionsOnCommonDaoAnnotation());
	...
	public static List<ICustomer> queryHis(ServiceContext context, Long custId) {
		Criteria crit = context.getBusinessDao().getSess().createCriteria(
				EntityPartitionHelper.getClassForPartition(ICustomer.class, custId));
		@SuppressWarnings("unchecked")
		List<ICustomer> list = 	crit.add(Restrictions.eq("custId", custId))
