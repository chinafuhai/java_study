...
/**
 * ICustomer entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
//@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_ALL", schema = "INTER")
@IdClass(ICustomerAll.ICustomerId.class)
//@PartitionNameForTable(operatedField=OperatedField.CUST_ID)
//@PartitionNameForTable.RegionCode(operatedField = OperatedField.CUST_ID)
//@Backup.CopyToSuffix
//@CommonDao(fieldOfSelectConditions = { "custId", "expireDate" },fieldOfDBSelectConditions={"cust_id","expire_date"})
public class ICustomerAll extends BaseEntity implements java.io.Serializable {
	...
	/** minimal constructor */
	public ICustomerAll(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomerId implements java.io.Serializable {
		...
		/** full constructor */
		public ICustomerId(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomerId) ) return false;
	        ICustomerId castOther = (ICustomerId) other;
	...
	public static List<ICustomerAll> queryInTimeRange(ServiceContext context, Long[] custIds, TimeRange range) {
		if (custIds.length == 0) return new ArrayList<ICustomerAll>(0);
		Criteria crit = context.getBusinessDao().getSess().createCriteria(ICustomerAll.class);
		@SuppressWarnings("unchecked")
		List<ICustomerAll> list = 	crit.add(Restrictions.in("custId", custIds))
										.add(Restrictions.le("validDate", range.getEndTime()))
										.add(Restrictions.ge("expireDate", range.getStartTime()))
										.addOrder(Order.desc("validDate"))
										.addOrder(Order.desc("custId"))
