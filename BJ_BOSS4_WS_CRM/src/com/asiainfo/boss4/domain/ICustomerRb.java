...
@Table(name = "I_CUSTOMER_RB", schema = "INTER")
@IdClass(ICustomerRb.ICustomerId.class)
@Backup
public class ICustomerRb implements java.io.Serializable {
	...
	/** minimal constructor */
	public ICustomerRb(Long custId, Long sid, Long soNbr, String custName, Byte custType,
			Byte vipFlag, Short custClass, Short regionCode,
			Short countyCode, Date beginDate, Date validDate, Date expireDate, Long rollbackSoNbr) {
		this.custId = custId;
		this.sid = sid;
		this.soNbr = soNbr;
	...
	public ICustomerRb(Long custId, Long sid, Long soNbr, String custName, Byte custType,
			...
			String custCode, Long rollbackSoNbr) {
		this.custId = custId;
		this.sid = sid;
		this.soNbr = soNbr;
		this.custName = custName;
