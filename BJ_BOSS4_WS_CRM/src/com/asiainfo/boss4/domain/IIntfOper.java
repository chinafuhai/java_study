...
/**
 * IIntfOper entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_INTF_OPER", schema = "ZG")
@AddOnly
public class IIntfOper implements java.io.Serializable {
	...
	/** minimal constructor */
	public IIntfOper(Long sid, Long soNbr, Integer busiCode,
