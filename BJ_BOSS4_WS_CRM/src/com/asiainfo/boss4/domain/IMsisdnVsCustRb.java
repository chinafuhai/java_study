...
@Table(name = "I_MSISDN_VS_CUST_RB", schema = "INTER")
@Backup
public class IMsisdnVsCustRb implements java.io.Serializable {
	...
	/** default constructor */
	public IMsisdnVsCustRb() {
	}

	/** minimal constructor */
	public IMsisdnVsCustRb(String msisdn, String custCode, Date validDate,
			Date expireDate, Long sid, Long soNbr, Long rollbackSoNbr) {
		this.msisdn = msisdn;
	...
	/** full constructor */
	public IMsisdnVsCustRb(String msisdn, Long custId, String custCode,
			Short regionCode, Date validDate, Date expireDate, Long sid,
			Long soNbr, String remark, Long rollbackSoNbr) {
		this.msisdn = msisdn;
		this.custId = custId;
		this.custCode = custCode;
