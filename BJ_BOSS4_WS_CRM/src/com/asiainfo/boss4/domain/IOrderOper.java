...
/**
 * IOrderOper entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
//@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ORDER_OPER", schema = "ZG")
@PartitionNameForTable(operatedField=OperatedField.OWNER_ID)
@PartitionNameForTable.RegionCode(operatedField=OperatedField.OWNER_ID)
@AddOnly
public class IOrderOper extends BaseEntity implements java.io.Serializable {
	...
	/** minimal constructor */
	public IOrderOper(Long sid, Long ownerId, String upField,
