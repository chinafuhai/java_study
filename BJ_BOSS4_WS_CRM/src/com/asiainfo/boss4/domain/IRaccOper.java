...
/**
 * IRaccOper entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
//@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER", schema = "ZG")
...
@AddOnly
public class IRaccOper implements java.io.Serializable {
	...
	/** minimal constructor */
	public IRaccOper(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper) ) return false;
        IRaccOper castOther = (IRaccOper) other;
