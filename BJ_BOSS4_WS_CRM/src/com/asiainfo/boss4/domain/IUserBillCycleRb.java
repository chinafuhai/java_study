...
/**
 * IUserBillCycleRb entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "I_USER_BILL_CYCLE_RB", schema = "INTER")
@IdClass(IUserBillCycleRb.IUserBillCycleRbId.class)
@Backup
public class IUserBillCycleRb implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycleRb() {
	}

	/** minimal constructor */
	public IUserBillCycleRb(Long servId, Long soNbr, Long rollbackSoNbr, Short regionCode,
	...
	public static class IUserBillCycleRbId implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycleRbId() {
		}

		/** full constructor */
		public IUserBillCycleRbId(Long servId, Long soNbr, Long rollbackSoNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
			this.rollbackSoNbr = rollbackSoNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycleRbId) ) return false;
			IUserBillCycleRbId castOther = (IUserBillCycleRbId) other;
