...
/**
 * IUserCellRb entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_RB", schema = "INTER")
@IdClass(IUserCellRb.IUserCellRbId.class)
@Backup
public class IUserCellRb implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserCellRb(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCellRbId implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCellRbId() {
		}

		/** full constructor */
		public IUserCellRbId(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCellRbId) ) return false;
	        IUserCellRbId castOther = (IUserCellRbId) other;
