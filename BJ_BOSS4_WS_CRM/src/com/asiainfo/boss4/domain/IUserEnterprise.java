...
@Table(name = "I_USER_ENTERPRISE", schema = "ZG")
@IdClass(IUserEnterprise.IUserEnterpriseId.class)
@PartitionNameForTable
@PartitionNameForTable.RegionCode
@AllowUpdateZeroRow
@AllowUpdateMultiRow
@CommonDao(fieldOfSelectConditions = {"servId","serviceCode","operatorCode","expireDate"},fieldOfDBSelectConditions={"serv_id","service_code","operator_code","expire_date"})
public class IUserEnterprise extends BaseEntity implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserEnterprise(Long servId, String spCode, String serviceCode,
	...
	public static class IUserEnterpriseId implements java.io.Serializable {
		...
		/** default constructor */
		public IUserEnterpriseId() {
		}

		/** full constructor */
		public IUserEnterpriseId(Long servId, String spCode, String serviceCode,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserEnterpriseId) ) return false;
			IUserEnterpriseId castOther = (IUserEnterpriseId) other;
