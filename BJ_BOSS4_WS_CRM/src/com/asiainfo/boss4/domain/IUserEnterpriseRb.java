...
@Table(name = "I_USER_ENTERPRISE_RB", schema = "INTER")
@IdClass(IUserEnterpriseRb.IUserEnterpriseRbId.class)
@Backup
public class IUserEnterpriseRb extends BaseEntity implements java.io.Serializable {
  ...
  private Long rollbackSoNbr;
	...
	/** default constructor */
	public IUserEnterpriseRb() {
	}

	/** minimal constructor */
	public IUserEnterpriseRb(Long servId, String spCode, String serviceCode,
	...
	public IUserEnterpriseRb(Long servId, String spCode, String serviceCode,
			...
			Byte replaceFlag, Date expireDate, String remark, Long sid, Long rollbackSoNbr) {
		this.servId = servId;
		this.spCode = spCode;
		this.serviceCode = serviceCode;
		this.operatorCode = operatorCode;
	...
	public static class IUserEnterpriseRbId implements java.io.Serializable {
		...
		/** default constructor */
		public IUserEnterpriseRbId() {
		}

		/** full constructor */
		public IUserEnterpriseRbId(Long servId, String spCode, String serviceCode,
				String operatorCode, Date validDate, Long sid) {
			this.servId = servId;
			this.spCode = spCode;
			this.serviceCode = serviceCode;
			this.operatorCode = operatorCode;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserEnterpriseRbId) ) return false;
			IUserEnterpriseRbId castOther = (IUserEnterpriseRbId) other;
