...
/**
 * IUserMap entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MAP", schema = "ZG")
@IdClass(IUserMap.IUserMapId.class)
@PartitionNameForTable
@PartitionNameForTable.RegionCode
@Backup.CopyToSuffix
@CommonDao(fieldOfSelectConditions = { "servId", "msisdn", "expireDate" },fieldOfDBSelectConditions={"serv_id","msisdn","expire_date"},isOverwriteWhenAdd = true,isAlertWhenNotExist = true)
public class IUserMap extends BaseEntity implements java.io.Serializable {
        ...
        /** minimal constructor */
        public IUserMap(String imsi, String msisdn, String imsi2, String msisdn2,
        ...
        public static class IUserMapId implements java.io.Serializable {
                // Fields
                ...
                /** full constructor */
                public IUserMapId(Long servId, Date validDate, Long sid, Long soNbr) {
                        this.servId = servId;
                        this.validDate = validDate;
                        this.sid = sid;
                        this.soNbr = soNbr;
                ...
                public boolean equals(Object other) {
                        if (!(other instanceof IUserMapId))
                                return false;
                        IUserMapId castOther = (IUserMapId) other;
