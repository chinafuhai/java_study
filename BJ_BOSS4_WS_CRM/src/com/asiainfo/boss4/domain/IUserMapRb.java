...
@Table(name = "I_USER_MAP_RB", schema = "INTER")
@IdClass(IUserMapRb.IUserMapId.class)
@Backup
public class IUserMapRb extends BaseEntity implements java.io.Serializable {
        ...
        /** minimal constructor */
        public IUserMapRb(String imsi, String msisdn, String imsi2, String msisdn2,
        ...
        public IUserMapRb(String imsi, String msisdn, String imsi2, String msisdn2,
                        ...
                        Long servId,Short busiType,Short regionCode,Long rollbackSoNbr) {
                this.imsi = imsi;
                this.msisdn = msisdn;
                this.imsi2 = imsi2;
                this.msisdn2 = msisdn2;
