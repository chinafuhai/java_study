...
import com.asiainfo.boss4.domain.IUserStatus.IUserStatusId;
...
/**
 * IUserMonitor entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
//@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR", schema = "ZG")
@IdClass(IUserMonitor.IUserMonitorId.class)
@PartitionNameForTable
@PartitionNameForTable.RegionCode
@CommonDao(fieldOfSelectConditions = { "servId", "monitorFlag","expireDate" },fieldOfDBSelectConditions={"serv_id","monitor_Flag","expire_date"})
public class IUserMonitor extends BaseEntity implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserMonitor(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitorId implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitorId() {
		}
	
		/** full constructor */
		public IUserMonitorId(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitorId) ) return false;
			IUserMonitorId castOther = (IUserMonitorId) other;
	...
	public BaseEntity add(ServiceContext context) {
		...
		IUserMonitor iUserMonitor = (IUserMonitor)dao.getEntity(this, new String[]{"servId","monitorFlag","expireDate"});
		
		if (iUserMonitor == null){
			return super.add(context);
		}else {
			  if (iUserMonitor.getExpireDate().after(this.getValidDate())){
				  return this;
			  }else{
				  iUserMonitor.setExpireDate(this.getExpireDate());
				  iUserMonitor.setSoNbr(this.getSoNbr());
				  iUserMonitor.setSid(this.getSid());
				  context.getBusinessDao().update(iUserMonitor);
	...
	public BaseEntity modify(ServiceContext context) {
		...
		//iUserMonitor.setMonitorCondid(this.getMonitorCondid());
        //iUserMonitor.setBillType(this.getBillType());
        //iUserMonitor.setSoNbr(this.getSoNbr());
        //iUserMonitor.setSid(this.getSid());
        //context.getBusinessDao().update(iUserMonitor);
