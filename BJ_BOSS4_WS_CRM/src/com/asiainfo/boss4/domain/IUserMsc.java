...
@Table(name = "I_USER_MSC", schema = "ZG")
@IdClass(IUserMsc.IUserMscId.class)
@PartitionNameForTable
@PartitionNameForTable.RegionCode
@AllowUpdateZeroRow
@AllowUpdateMultiRow
@Backup.CopyToSuffix
public class IUserMsc implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserMsc(Long servId, Integer prodId, Integer busiType,
