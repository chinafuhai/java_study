...
@Table(name = "I_USER_PARAM", schema = "ZG")
@IdClass(IUserParam.IUserParamId.class)
@PartitionNameForTable
@PartitionNameForTable.RegionCode
@Backup.CopyToSuffix
@CommonDao(fieldOfSelectConditions = { "servId", "keyId", "expireDate" },fieldOfDBSelectConditions={"serv_id","key_id","expire_date"})
public class IUserParam extends BaseEntity implements java.io.Serializable{
        ...
        /** minimal constructor */
        public IUserParam(Long servId, Date validDate, Date expireDate, Long sid,
                        Long soNbr) {
                this.servId = servId;
        ...
        /** full constructor */
        public IUserParam(Long servId, Integer keyId,
        ...
        public static class IUserParamId implements java.io.Serializable {
                ...
                /** full constructor */
                public IUserParamId(Long servId, Integer keyId, Date validDate) {
                        this.servId = servId;
                        this.keyId = keyId;
                        this.validDate = validDate;
                }
                ...
                public boolean equals(Object other) {
                   if ( !(other instanceof IUserParamId) ) return false;
                   IUserParamId castOther = (IUserParamId) other;
