...
@Table(name = "I_USER_PAY_RELATION_RB", schema = "INTER")
@IdClass(IUserPayRelationRb.IUserPayRelationId.class)
@Backup
public class IUserPayRelationRb implements java.io.Serializable {
	...
	/** default constructor */
	public IUserPayRelationRb() {
	}

	/** minimal constructor */
	public IUserPayRelationRb(Long servId, Long acctId, Short useMode,
			Integer payIndex, Date validDate, Short regionCode,
			Long mainServId, Short priority, Date beginDate, Date expireDate,
			Long sid, Long soNbr, Byte paySts, Date stsDate, Long rollbackSoNbr) {
		this.servId = servId;
		this.acctId = acctId;
	...
	public IUserPayRelationRb(Long servId, Long acctId, Short useMode,
			...
			Short payPercent, Byte payType, Integer payItem, Byte paySts, Date stsDate, Long rollbackSoNbr) {
		this.servId = servId;
		this.acctId = acctId;
		this.useMode = useMode;
		this.payIndex = payIndex;
