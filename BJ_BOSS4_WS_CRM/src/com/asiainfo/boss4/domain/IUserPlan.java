...
@Table(name = "I_USER_PLAN", schema = "ZG")
@IdClass(IUserPlan.IUserPlanId.class)
@PartitionNameForTable
@PartitionNameForTable.RegionCode
@Backup.CopyToSuffix
@CommonDao(fieldOfSelectConditions = { "servId","planId","expireDate" },fieldOfDBSelectConditions={"serv_id","plan_id","expire_date"})
public class IUserPlan extends BaseEntity implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserPlan(Long servId, Date validDate, Long sid, Long soNbr, Integer planId, Short regionCode,
			Date expireDate) {
		this.servId = servId;
