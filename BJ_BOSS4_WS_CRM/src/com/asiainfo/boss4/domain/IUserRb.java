...
@Table(name = "I_USER_RB", schema = "INTER")
@IdClass(IUserRb.IUserRbId.class)
@Backup
public class IUserRb implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserRb(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
			...
			Byte aocFlag, Long ctrlFunc, Long rollbackSoNbr) {
		this.servId = servId;
	...
	public IUserRb(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
			...
			Short nextCycleDay, Date firstUseTime, Long mainServId, Long rollbackSoNbr) {
		this.servId = servId;
		this.validDate = validDate;
		this.sid = sid;
		this.soNbr = soNbr;
	...
	public static class IUserRbId implements java.io.Serializable {
		// Fields
		...
		/** full constructor */
		public IUserRbId(Long servId, Date validDate, Long sid, Long soNbr) {
			this.servId = servId;
			this.validDate = validDate;
			this.sid = sid;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserRbId))
				return false;
			IUserRbId castOther = (IUserRbId) other;
