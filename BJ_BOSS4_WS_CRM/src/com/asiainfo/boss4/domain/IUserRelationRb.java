...
@Table(name = "I_USER_RELATION_RB", schema = "INTER")
@IdClass(IUserRelationRb.IUserRelationRbId.class)
@Backup
public class IUserRelationRb implements java.io.Serializable {
	...
	/** default constructor */
	public IUserRelationRb() {
	}

	/** minimal constructor */
	public IUserRelationRb(Long servId, Integer busiType, String rservId,
	...
	public IUserRelationRb(Long servId, Integer busiType, String rservId,
			...
			String property, Long soNbr, String remark, Long rollbackSoNbr) {
		this.servId = servId;
		this.busiType = busiType;
		this.rservId = rservId;
		this.validDate = validDate;
	...
	public static class IUserRelationRbId implements java.io.Serializable {
		...
		/** default constructor */
		public void IUserRelationId() {
		}

		/** full constructor */
		public void IUserRelationId(Long servId, Integer busiType, String rservId,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserRelationRbId) ) return false;
	        IUserRelationRbId castOther = (IUserRelationRbId) other;
