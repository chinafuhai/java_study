...
/**
 * IUserRoamRent entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
//@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_ROAM_RENT", schema = "ZG")
@IdClass(IUserRoamRent.IUserRoamRentId.class)
@PartitionNameForTable
@PartitionNameForTable.RegionCode
@AllowUpdateZeroRow
@AllowUpdateMultiRow
public class IUserRoamRent implements java.io.Serializable {
	...
	/** default constructor */
	public IUserRoamRent() {
	}

	/** minimal constructor */
	public IUserRoamRent(Long servId, String roamMsisdn, Date validDate, String msisdn, Integer rentId,
	...
	public static class IUserRoamRentId implements java.io.Serializable {
		...
		/** default constructor */
		public IUserRoamRentId() {
		}

		/** full constructor */
		public IUserRoamRentId(Long servId, String roamMsisdn, Date validDate) {
			this.servId = servId;
			this.roamMsisdn = roamMsisdn;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserRoamRentId) ) return false;
			IUserRoamRentId castOther = (IUserRoamRentId) other;
