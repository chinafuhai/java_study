...
@Table(name = "I_USER_SPROM_RB", schema = "INTER")
@IdClass(IUserSpromRb.IUserSpromRbId.class)
@Backup
public class IUserSpromRb implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserSpromRb(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSpromRbId implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSpromRbId() {
		}

		/** full constructor */
		public IUserSpromRbId(Long servId, Long soNbr, Long sid,Byte operType,Date validDate,Long soId) {
			this.servId = servId;
			this.soNbr = soNbr;
			this.sid = sid;
			this.operType = operType;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSpromRbId) ) return false;
	        IUserSpromRbId castOther = (IUserSpromRbId) other;
