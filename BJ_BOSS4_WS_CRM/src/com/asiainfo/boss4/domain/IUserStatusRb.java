...
@Table(name = "I_USER_STATUS_RB", schema = "INTER")
@IdClass(IUserStatusRb.IUserStatusRbId.class)
@Backup
public class IUserStatusRb implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatusRb() {
	}

	/** minimal constructor */
	public IUserStatusRb(Long servId, Long sid, Long soNbr, Byte userSts, Short userType,
			Short brand, Integer planId, Short regionCode, Short countyCode,
			Integer orgId, Date beginDate, Date validDate, Date expireDate, Long rollbackSoNbr) {
		this.servId = servId;
		this.sid = sid;
		this.soNbr = soNbr;
	...
	/** full constructor */
	public IUserStatusRb(Long servId, Long sid, Long soNbr, Byte userSts, Byte operSts,
			...
			Date validDate, Date expireDate, String remark, Long rollbackSoNbr) {
		this.servId = servId;
		this.sid = sid;
		this.soNbr = soNbr;
		this.userSts = userSts;
	...
	public static class IUserStatusRbId implements java.io.Serializable {
		...
		/** default constructor */
		public IUserStatusRbId() {
		}

		/** full constructor */
		public IUserStatusRbId(Long servId, Long sid, Long soNbr) {
			this.servId = servId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserStatusRbId) ) return false;
			IUserStatusRbId castOther = (IUserStatusRbId) other;
