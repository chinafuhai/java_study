...
/**
 * IUserStatusRec entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
//@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_REC", schema = "ZG")
@PartitionNameForTable
@AllowUpdateZeroRow
@AllowUpdateMultiRow
public class IUserStatusRec implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatusRec() {
	}

	/** minimal constructor */
	public IUserStatusRec(Long servId, Date commitDate) {
		this.servId = servId;
		this.commitDate = commitDate;
	}

	/** full constructor */
	public IUserStatusRec(Long servId, Byte mgntSts, String remark, Date commitDate) {
		this.servId = servId;
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IUserStatusRec) ) return false;
		IUserStatusRec castOther = (IUserStatusRec) other;
