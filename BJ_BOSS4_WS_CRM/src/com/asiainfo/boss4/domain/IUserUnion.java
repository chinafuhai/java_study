...
import com.asiainfo.boss4.support.annotation.Change.PrimaryKey;
...
@Table(name = "I_USER_UNION", schema = "INTER")
...
@Deprecated
public class IUserUnion extends IUser implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserUnion(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
...
//	public static class IUserUnionId implements java.io.Serializable {
//		// Fields
//
//		private Long servId;
//		private Date validDate;
...
//
//		/** full constructor */
//		public IUserUnionId(Long servId, Date validDate, Long sid, Long soNbr) {
//			this.servId = servId;
//			this.validDate = validDate;
//			this.sid = sid;
//			this.soNbr = soNbr;
...
//			if (!(other instanceof IUserUnionId))
//				return false;
//			IUserUnionId castOther = (IUserUnionId) other;
