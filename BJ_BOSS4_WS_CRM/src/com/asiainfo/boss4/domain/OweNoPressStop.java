...
/**
 * OweNoPressStop entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "OWE_NO_PRESS_STOP", schema = "ZG")
@IdClass(OweNoPressStop.OweNoPressStopId.class)
public class OweNoPressStop implements java.io.Serializable {
	...
	/** default constructor */
	public OweNoPressStop() {
	}

	/** minimal constructor */
	public OweNoPressStop(Long servId, Integer subbusiId, Long custId,
	...
	public static class OweNoPressStopId implements java.io.Serializable {
		...
		/** default constructor */
		public OweNoPressStopId() {
		}

		/** full constructor */
		public OweNoPressStopId(Long servId, Integer subbusiId, Long custId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof OweNoPressStopId) ) return false;
			OweNoPressStopId castOther = (OweNoPressStopId) other;
