...
/**
 * OweNoPressStopHis entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "OWE_NO_PRESS_STOP_HIS", schema = "ZG")
@IdClass(OweNoPressStopHis.OweNoPressStopHisId.class)
public class OweNoPressStopHis implements java.io.Serializable {
	...
	/** default constructor */
	public OweNoPressStopHis() {
	}

	/** minimal constructor */
	public OweNoPressStopHis(Long servId, Integer subbusiId, Long custId,
	...
	public static class OweNoPressStopHisId implements java.io.Serializable {
		...
		/** default constructor */
		public OweNoPressStopHisId() {
		}

		/** full constructor */
		public OweNoPressStopHisId(Long servId, Integer subbusiId, Long custId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof OweNoPressStopHisId) ) return false;
			OweNoPressStopHisId castOther = (OweNoPressStopHisId) other;
