...
@Table(name = "PM_FREEBIE_REMIND_LEVEL", schema = "CP")
@IdClass(PmFreebieRemindLevel.PmFreebieRemindLevelId.class)
...
public class PmFreebieRemindLevel extends BaseEntity implements java.io.Serializable{
	...
	/** default constructor */
	public PmFreebieRemindLevel() {
	}

	public PmFreebieRemindLevel(Short remindType, Short denominator, Short numerator,
	...
	public static class PmFreebieRemindLevelId implements java.io.Serializable {
		...
		public PmFreebieRemindLevelId() {

		}
		
		public PmFreebieRemindLevelId(Short regionCode, Short remindFlow, Integer freebieId,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof PmFreebieRemindLevelId) ) return false;
	        PmFreebieRemindLevelId castOther = (PmFreebieRemindLevelId) other;
