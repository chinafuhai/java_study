...
/**
 * AccBookChgNotify0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_BOOK_CHG_NOTIFY_0101", schema = "ZG")
@IdClass(AccBookChgNotify0101.AccBookChgNotify0101Id.class)
public class AccBookChgNotify0101 extends AccBookChgNotify implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotify0101() {
	}

	/** minimal constructor */
	public AccBookChgNotify0101(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotify0101(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotify0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotify0101Id() {
		}

		/** full constructor */
		public AccBookChgNotify0101Id(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotify0101Id) ) return false;
			AccBookChgNotify0101Id castOther = (AccBookChgNotify0101Id) other;
