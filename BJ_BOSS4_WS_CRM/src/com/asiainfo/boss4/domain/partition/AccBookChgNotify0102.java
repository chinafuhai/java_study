...
/**
 * AccBookChgNotify0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_BOOK_CHG_NOTIFY_0102", schema = "ZG")
@IdClass(AccBookChgNotify0102.AccBookChgNotify0102Id.class)
public class AccBookChgNotify0102 extends AccBookChgNotify implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotify0102() {
	}

	/** minimal constructor */
	public AccBookChgNotify0102(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotify0102(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotify0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotify0102Id() {
		}

		/** full constructor */
		public AccBookChgNotify0102Id(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotify0102Id) ) return false;
			AccBookChgNotify0102Id castOther = (AccBookChgNotify0102Id) other;
