...
/**
 * AccBookChgNotify0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_BOOK_CHG_NOTIFY_0103", schema = "ZG")
@IdClass(AccBookChgNotify0103.AccBookChgNotify0103Id.class)
public class AccBookChgNotify0103 extends AccBookChgNotify implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotify0103() {
	}

	/** minimal constructor */
	public AccBookChgNotify0103(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotify0103(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotify0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotify0103Id() {
		}

		/** full constructor */
		public AccBookChgNotify0103Id(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotify0103Id) ) return false;
			AccBookChgNotify0103Id castOther = (AccBookChgNotify0103Id) other;
