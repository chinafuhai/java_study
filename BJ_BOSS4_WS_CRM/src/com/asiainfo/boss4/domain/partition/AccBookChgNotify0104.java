...
/**
 * AccBookChgNotify0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_BOOK_CHG_NOTIFY_0104", schema = "ZG")
@IdClass(AccBookChgNotify0104.AccBookChgNotify0104Id.class)
public class AccBookChgNotify0104 extends AccBookChgNotify implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotify0104() {
	}

	/** minimal constructor */
	public AccBookChgNotify0104(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotify0104(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotify0104Id implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotify0104Id() {
		}

		/** full constructor */
		public AccBookChgNotify0104Id(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotify0104Id) ) return false;
			AccBookChgNotify0104Id castOther = (AccBookChgNotify0104Id) other;
