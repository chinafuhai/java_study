...
/**
 * AccBookChgNotify0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_BOOK_CHG_NOTIFY_0105", schema = "ZG")
@IdClass(AccBookChgNotify0105.AccBookChgNotify0105Id.class)
public class AccBookChgNotify0105 extends AccBookChgNotify implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotify0105() {
	}

	/** minimal constructor */
	public AccBookChgNotify0105(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotify0105(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotify0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotify0105Id() {
		}

		/** full constructor */
		public AccBookChgNotify0105Id(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotify0105Id) ) return false;
			AccBookChgNotify0105Id castOther = (AccBookChgNotify0105Id) other;
