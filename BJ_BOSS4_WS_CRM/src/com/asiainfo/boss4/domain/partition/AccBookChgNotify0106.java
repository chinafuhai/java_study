...
/**
 * AccBookChgNotify0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_BOOK_CHG_NOTIFY_0106", schema = "ZG")
@IdClass(AccBookChgNotify0106.AccBookChgNotify0106Id.class)
public class AccBookChgNotify0106 extends AccBookChgNotify implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotify0106() {
	}

	/** minimal constructor */
	public AccBookChgNotify0106(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotify0106(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotify0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotify0106Id() {
		}

		/** full constructor */
		public AccBookChgNotify0106Id(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotify0106Id) ) return false;
			AccBookChgNotify0106Id castOther = (AccBookChgNotify0106Id) other;
