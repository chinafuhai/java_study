...
/**
 * AccBookChgNotify0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_BOOK_CHG_NOTIFY_0107", schema = "ZG")
@IdClass(AccBookChgNotify0107.AccBookChgNotify0107Id.class)
public class AccBookChgNotify0107 extends AccBookChgNotify implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotify0107() {
	}

	/** minimal constructor */
	public AccBookChgNotify0107(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotify0107(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotify0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotify0107Id() {
		}

		/** full constructor */
		public AccBookChgNotify0107Id(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotify0107Id) ) return false;
			AccBookChgNotify0107Id castOther = (AccBookChgNotify0107Id) other;
