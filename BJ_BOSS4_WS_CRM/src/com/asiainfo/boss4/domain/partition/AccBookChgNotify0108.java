...
/**
 * AccBookChgNotify0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_BOOK_CHG_NOTIFY_0108", schema = "ZG")
@IdClass(AccBookChgNotify0108.AccBookChgNotify0108Id.class)
public class AccBookChgNotify0108 extends AccBookChgNotify implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotify0108() {
	}

	/** minimal constructor */
	public AccBookChgNotify0108(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotify0108(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotify0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotify0108Id() {
		}

		/** full constructor */
		public AccBookChgNotify0108Id(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotify0108Id) ) return false;
			AccBookChgNotify0108Id castOther = (AccBookChgNotify0108Id) other;
