...
/**
 * AccBookChgNotify0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "ACC_BOOK_CHG_NOTIFY_0110", schema = "ZG")
@IdClass(AccBookChgNotify0110.AccBookChgNotify0110Id.class)
public class AccBookChgNotify0110 extends AccBookChgNotify implements java.io.Serializable {
	...
	/** default constructor */
	public AccBookChgNotify0110() {
	}

	/** minimal constructor */
	public AccBookChgNotify0110(Long soNbr, Long acctId, Short soRegionCode,
			String soMonth) {
		this.soNbr = soNbr;
		this.acctId = acctId;
	...
	/** full constructor */
	public AccBookChgNotify0110(Long soNbr, Long acctId, Date createDate,
	...
	public static class AccBookChgNotify0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public AccBookChgNotify0110Id() {
		}

		/** full constructor */
		public AccBookChgNotify0110Id(Long soNbr, Long acctId) {
			this.soNbr = soNbr;
			this.acctId = acctId;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof AccBookChgNotify0110Id) ) return false;
			AccBookChgNotify0110Id castOther = (AccBookChgNotify0110Id) other;
