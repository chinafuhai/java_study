...
/**
 * CcPlanInstanceRelation0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CC_PLAN_INSTANCE_RELATION_0101", schema = "ZG")
public class CcPlanInstanceRelation0101 extends CcPlanInstanceRelation implements java.io.Serializable {
	...
	/** default constructor */
	public CcPlanInstanceRelation0101() {
	}

	/** full constructor */
	public CcPlanInstanceRelation0101(Long relationId, Integer ccPlanId,
