...
/**
 * CcPlanInstanceRelation0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CC_PLAN_INSTANCE_RELATION_0102", schema = "ZG")
public class CcPlanInstanceRelation0102 extends CcPlanInstanceRelation implements java.io.Serializable {
	...
	/** default constructor */
	public CcPlanInstanceRelation0102() {
	}

	/** full constructor */
	public CcPlanInstanceRelation0102(Long relationId, Integer ccPlanId,
