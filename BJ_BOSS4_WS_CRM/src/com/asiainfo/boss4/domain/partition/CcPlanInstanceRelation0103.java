...
/**
 * CcPlanInstanceRelation0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CC_PLAN_INSTANCE_RELATION_0103", schema = "ZG")
public class CcPlanInstanceRelation0103 extends CcPlanInstanceRelation implements java.io.Serializable {
	...
	/** default constructor */
	public CcPlanInstanceRelation0103() {
	}

	/** full constructor */
	public CcPlanInstanceRelation0103(Long relationId, Integer ccPlanId,
