...
/**
 * CcPlanInstanceRelation0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CC_PLAN_INSTANCE_RELATION_0104", schema = "ZG")
public class CcPlanInstanceRelation0104 extends CcPlanInstanceRelation implements java.io.Serializable {
	...
	/** default constructor */
	public CcPlanInstanceRelation0104() {
	}

	/** full constructor */
	public CcPlanInstanceRelation0104(Long relationId, Integer ccPlanId,
