...
/**
 * CcPlanInstanceRelation0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CC_PLAN_INSTANCE_RELATION_0105", schema = "ZG")
public class CcPlanInstanceRelation0105 extends CcPlanInstanceRelation implements java.io.Serializable {
	...
	/** default constructor */
	public CcPlanInstanceRelation0105() {
	}

	/** full constructor */
	public CcPlanInstanceRelation0105(Long relationId, Integer ccPlanId,
