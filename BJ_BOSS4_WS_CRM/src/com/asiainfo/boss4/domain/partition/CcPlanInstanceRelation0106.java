...
/**
 * CcPlanInstanceRelation0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CC_PLAN_INSTANCE_RELATION_0106", schema = "ZG")
public class CcPlanInstanceRelation0106 extends CcPlanInstanceRelation implements java.io.Serializable {
	...
	/** default constructor */
	public CcPlanInstanceRelation0106() {
	}

	/** full constructor */
	public CcPlanInstanceRelation0106(Long relationId, Integer ccPlanId,
