...
/**
 * CcPlanInstanceRelation0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CC_PLAN_INSTANCE_RELATION_0107", schema = "ZG")
public class CcPlanInstanceRelation0107 extends CcPlanInstanceRelation implements java.io.Serializable {
	...
	/** default constructor */
	public CcPlanInstanceRelation0107() {
	}

	/** full constructor */
	public CcPlanInstanceRelation0107(Long relationId, Integer ccPlanId,
