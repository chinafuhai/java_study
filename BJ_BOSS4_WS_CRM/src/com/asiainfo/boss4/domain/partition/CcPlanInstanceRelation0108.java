...
/**
 * CcPlanInstanceRelation0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CC_PLAN_INSTANCE_RELATION_0108", schema = "ZG")
public class CcPlanInstanceRelation0108 extends CcPlanInstanceRelation implements java.io.Serializable {
	...
	/** default constructor */
	public CcPlanInstanceRelation0108() {
	}

	/** full constructor */
	public CcPlanInstanceRelation0108(Long relationId, Integer ccPlanId,
