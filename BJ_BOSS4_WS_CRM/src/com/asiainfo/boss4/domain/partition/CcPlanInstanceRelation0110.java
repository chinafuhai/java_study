...
/**
 * CcPlanInstanceRelation0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "CC_PLAN_INSTANCE_RELATION_0110", schema = "ZG")
public class CcPlanInstanceRelation0110 extends CcPlanInstanceRelation implements java.io.Serializable {
	...
	/** default constructor */
	public CcPlanInstanceRelation0110() {
	}

	/** full constructor */
	public CcPlanInstanceRelation0110(Long relationId, Integer ccPlanId,
