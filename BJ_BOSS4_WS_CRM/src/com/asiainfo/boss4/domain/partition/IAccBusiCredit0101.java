...
/**
 * IAccBusiCredit0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACC_BUSI_CREDIT_0101", schema = "ZG")
@IdClass(IAccBusiCredit0101.IAccBusiCredit0101Id.class)
public class IAccBusiCredit0101 extends IAccBusiCredit implements java.io.Serializable {
	...
	/** default constructor */
	public IAccBusiCredit0101() {
	}

	/** minimal constructor */
	public IAccBusiCredit0101(Long acctId, Integer serviceId, Long busiCredit, Long sid, Long soNbr,
	...
	public static class IAccBusiCredit0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccBusiCredit0101Id() {
		}

		/** full constructor */
		public IAccBusiCredit0101Id(Long acctId, Integer serviceId, Integer creditLevel, Long servId) {
			this.acctId = acctId;
			this.serviceId = serviceId;
			this.creditLevel = creditLevel;
			this.servId = servId;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccBusiCredit0101Id) ) return false;
	        IAccBusiCredit0101Id castOther = (IAccBusiCredit0101Id) other;
