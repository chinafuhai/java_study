...
/**
 * IAccBusiCredit0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACC_BUSI_CREDIT_0102", schema = "ZG")
@IdClass(IAccBusiCredit0102.IAccBusiCredit0102Id.class)
public class IAccBusiCredit0102 extends IAccBusiCredit implements java.io.Serializable {
	...
	/** default constructor */
	public IAccBusiCredit0102() {
	}

	/** minimal constructor */
	public IAccBusiCredit0102(Long acctId, Integer serviceId, Long busiCredit, Long sid, Long soNbr,
	...
	public static class IAccBusiCredit0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccBusiCredit0102Id() {
		}

		/** full constructor */
		public IAccBusiCredit0102Id(Long acctId, Integer serviceId, Integer creditLevel, Long servId) {
			this.acctId = acctId;
			this.serviceId = serviceId;
			this.creditLevel = creditLevel;
			this.servId = servId;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccBusiCredit0102Id) ) return false;
	        IAccBusiCredit0102Id castOther = (IAccBusiCredit0102Id) other;
