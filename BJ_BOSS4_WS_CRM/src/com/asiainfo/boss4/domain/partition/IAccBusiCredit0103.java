...
/**
 * IAccBusiCredit0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACC_BUSI_CREDIT_0103", schema = "ZG")
@IdClass(IAccBusiCredit0103.IAccBusiCredit0103Id.class)
public class IAccBusiCredit0103 extends IAccBusiCredit implements java.io.Serializable {
	...
	/** default constructor */
	public IAccBusiCredit0103() {
	}

	/** minimal constructor */
	public IAccBusiCredit0103(Long acctId, Integer serviceId, Long busiCredit, Long sid, Long soNbr,
	...
	public static class IAccBusiCredit0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccBusiCredit0103Id() {
		}

		/** full constructor */
		public IAccBusiCredit0103Id(Long acctId, Integer serviceId, Integer creditLevel, Long servId) {
			this.acctId = acctId;
			this.serviceId = serviceId;
			this.creditLevel = creditLevel;
			this.servId = servId;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccBusiCredit0103Id) ) return false;
	        IAccBusiCredit0103Id castOther = (IAccBusiCredit0103Id) other;
