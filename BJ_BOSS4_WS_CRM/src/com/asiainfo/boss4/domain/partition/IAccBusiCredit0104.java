...
/**
 * IAccBusiCredit0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACC_BUSI_CREDIT_0104", schema = "ZG")
@IdClass(IAccBusiCredit0104.IAccBusiCredit0104Id.class)
public class IAccBusiCredit0104 extends IAccBusiCredit implements java.io.Serializable {
	...
	/** default constructor */
	public IAccBusiCredit0104() {
	}

	/** minimal constructor */
	public IAccBusiCredit0104(Long acctId, Integer serviceId, Long busiCredit, Long sid, Long soNbr,
	...
	public static class IAccBusiCredit0104Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccBusiCredit0104Id() {
		}

		/** full constructor */
		public IAccBusiCredit0104Id(Long acctId, Integer serviceId, Integer creditLevel, Long servId) {
			this.acctId = acctId;
			this.serviceId = serviceId;
			this.creditLevel = creditLevel;
			this.servId = servId;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccBusiCredit0104Id) ) return false;
	        IAccBusiCredit0104Id castOther = (IAccBusiCredit0104Id) other;
