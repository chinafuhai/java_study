...
/**
 * IAccBusiCredit0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACC_BUSI_CREDIT_0106", schema = "ZG")
@IdClass(IAccBusiCredit0106.IAccBusiCredit0106Id.class)
public class IAccBusiCredit0106 extends IAccBusiCredit implements java.io.Serializable {
	...
	/** default constructor */
	public IAccBusiCredit0106() {
	}

	/** minimal constructor */
	public IAccBusiCredit0106(Long acctId, Integer serviceId, Long busiCredit, Long sid, Long soNbr,
	...
	public static class IAccBusiCredit0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccBusiCredit0106Id() {
		}

		/** full constructor */
		public IAccBusiCredit0106Id(Long acctId, Integer serviceId, Integer creditLevel, Long servId) {
			this.acctId = acctId;
			this.serviceId = serviceId;
			this.creditLevel = creditLevel;
			this.servId = servId;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccBusiCredit0106Id) ) return false;
	        IAccBusiCredit0106Id castOther = (IAccBusiCredit0106Id) other;
