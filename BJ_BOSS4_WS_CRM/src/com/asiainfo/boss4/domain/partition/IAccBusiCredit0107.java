...
/**
 * IAccBusiCredit0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACC_BUSI_CREDIT_0107", schema = "ZG")
@IdClass(IAccBusiCredit0107.IAccBusiCredit0107Id.class)
public class IAccBusiCredit0107 extends IAccBusiCredit implements java.io.Serializable {
	...
	/** default constructor */
	public IAccBusiCredit0107() {
	}

	/** minimal constructor */
	public IAccBusiCredit0107(Long acctId, Integer serviceId, Long busiCredit, Long sid, Long soNbr,
	...
	public static class IAccBusiCredit0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccBusiCredit0107Id() {
		}

		/** full constructor */
		public IAccBusiCredit0107Id(Long acctId, Integer serviceId, Integer creditLevel, Long servId) {
			this.acctId = acctId;
			this.serviceId = serviceId;
			this.creditLevel = creditLevel;
			this.servId = servId;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccBusiCredit0107Id) ) return false;
	        IAccBusiCredit0107Id castOther = (IAccBusiCredit0107Id) other;
