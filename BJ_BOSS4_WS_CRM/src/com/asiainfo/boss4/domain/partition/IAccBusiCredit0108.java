...
/**
 * IAccBusiCredit0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACC_BUSI_CREDIT_0108", schema = "ZG")
@IdClass(IAccBusiCredit0108.IAccBusiCredit0108Id.class)
public class IAccBusiCredit0108 extends IAccBusiCredit implements java.io.Serializable {
	...
	/** default constructor */
	public IAccBusiCredit0108() {
	}

	/** minimal constructor */
	public IAccBusiCredit0108(Long acctId, Integer serviceId, Long busiCredit, Long sid, Long soNbr,
	...
	public static class IAccBusiCredit0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccBusiCredit0108Id() {
		}

		/** full constructor */
		public IAccBusiCredit0108Id(Long acctId, Integer serviceId, Integer creditLevel, Long servId) {
			this.acctId = acctId;
			this.serviceId = serviceId;
			this.creditLevel = creditLevel;
			this.servId = servId;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccBusiCredit0108Id) ) return false;
	        IAccBusiCredit0108Id castOther = (IAccBusiCredit0108Id) other;
