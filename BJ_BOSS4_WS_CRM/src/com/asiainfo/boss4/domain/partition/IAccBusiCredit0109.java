...
/**
 * IAccBusiCredit0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACC_BUSI_CREDIT_0109", schema = "ZG")
@IdClass(IAccBusiCredit0109.IAccBusiCredit0109Id.class)
public class IAccBusiCredit0109 extends IAccBusiCredit implements java.io.Serializable {
	...
	/** default constructor */
	public IAccBusiCredit0109() {
	}

	/** minimal constructor */
	public IAccBusiCredit0109(Long acctId, Integer serviceId, Long busiCredit, Long sid, Long soNbr,
	...
	public static class IAccBusiCredit0109Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccBusiCredit0109Id() {
		}

		/** full constructor */
		public IAccBusiCredit0109Id(Long acctId, Integer serviceId, Integer creditLevel, Long servId) {
			this.acctId = acctId;
			this.serviceId = serviceId;
			this.creditLevel = creditLevel;
			this.servId = servId;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccBusiCredit0109Id) ) return false;
	        IAccBusiCredit0109Id castOther = (IAccBusiCredit0109Id) other;
