...
/**
 * IAccount0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACCOUNT_0101", schema = "ZG")
@IdClass(IAccount0101.IAccount0101Id.class)
public class IAccount0101 extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccount0101(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static class IAccount0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccount0101Id() {
		}

		/** full constructor */
		public IAccount0101Id(Long acctId, Long sid, Long soNbr) {
			this.acctId = acctId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccount0101Id) ) return false;
	        IAccount0101Id castOther = (IAccount0101Id) other;
