...
/**
 * IAccount0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACCOUNT_0102", schema = "ZG")
@IdClass(IAccount0102.IAccount0102Id.class)
public class IAccount0102 extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccount0102(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static class IAccount0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccount0102Id() {
		}

		/** full constructor */
		public IAccount0102Id(Long acctId, Long sid, Long soNbr) {
			this.acctId = acctId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccount0102Id) ) return false;
	        IAccount0102Id castOther = (IAccount0102Id) other;
