...
/**
 * IAccount0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACCOUNT_0104", schema = "ZG")
@IdClass(IAccount0104.IAccount0104Id.class)
public class IAccount0104 extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccount0104(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static class IAccount0104Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccount0104Id() {
		}

		/** full constructor */
		public IAccount0104Id(Long acctId, Long sid, Long soNbr) {
			this.acctId = acctId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccount0104Id) ) return false;
	        IAccount0104Id castOther = (IAccount0104Id) other;
