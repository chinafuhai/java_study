...
/**
 * IAccount0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACCOUNT_0105", schema = "ZG")
@IdClass(IAccount0105.IAccount0105Id.class)
public class IAccount0105 extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccount0105(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static class IAccount0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccount0105Id() {
		}

		/** full constructor */
		public IAccount0105Id(Long acctId, Long sid, Long soNbr) {
			this.acctId = acctId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccount0105Id) ) return false;
	        IAccount0105Id castOther = (IAccount0105Id) other;
