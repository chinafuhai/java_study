...
/**
 * IAccount0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACCOUNT_0106", schema = "ZG")
@IdClass(IAccount0106.IAccount0106Id.class)
public class IAccount0106 extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccount0106(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static class IAccount0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccount0106Id() {
		}

		/** full constructor */
		public IAccount0106Id(Long acctId, Long sid, Long soNbr) {
			this.acctId = acctId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccount0106Id) ) return false;
	        IAccount0106Id castOther = (IAccount0106Id) other;
