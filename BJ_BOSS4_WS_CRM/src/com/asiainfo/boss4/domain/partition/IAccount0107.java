...
/**
 * IAccount0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACCOUNT_0107", schema = "ZG")
@IdClass(IAccount0107.IAccount0107Id.class)
public class IAccount0107 extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccount0107(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static class IAccount0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccount0107Id() {
		}

		/** full constructor */
		public IAccount0107Id(Long acctId, Long sid, Long soNbr) {
			this.acctId = acctId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccount0107Id) ) return false;
	        IAccount0107Id castOther = (IAccount0107Id) other;
