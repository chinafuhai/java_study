...
/**
 * IAccount0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACCOUNT_0108", schema = "ZG")
@IdClass(IAccount0108.IAccount0108Id.class)
public class IAccount0108 extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccount0108(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static class IAccount0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccount0108Id() {
		}

		/** full constructor */
		public IAccount0108Id(Long acctId, Long sid, Long soNbr) {
			this.acctId = acctId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccount0108Id) ) return false;
	        IAccount0108Id castOther = (IAccount0108Id) other;
