...
/**
 * IAccount0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACCOUNT_0109", schema = "ZG")
@IdClass(IAccount0109.IAccount0109Id.class)
public class IAccount0109 extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccount0109(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static class IAccount0109Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccount0109Id() {
		}

		/** full constructor */
		public IAccount0109Id(Long acctId, Long sid, Long soNbr) {
			this.acctId = acctId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccount0109Id) ) return false;
	        IAccount0109Id castOther = (IAccount0109Id) other;
