...
/**
 * IAccount0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_ACCOUNT_0110", schema = "ZG")
@IdClass(IAccount0110.IAccount0110Id.class)
public class IAccount0110 extends IAccount implements java.io.Serializable {
	...
	/** minimal constructor */
	public IAccount0110(Long acctId, Long sid, Long soNbr, String acctName, Byte acctType,
	...
	public static class IAccount0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public IAccount0110Id() {
		}

		/** full constructor */
		public IAccount0110Id(Long acctId, Long sid, Long soNbr) {
			this.acctId = acctId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IAccount0110Id) ) return false;
	        IAccount0110Id castOther = (IAccount0110Id) other;
