...
/**
 * ICustomer0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_0101", schema = "ZG")
@IdClass(ICustomer0101.ICustomer0101Id.class)
public class ICustomer0101 extends ICustomer implements java.io.Serializable {
	...
	/** default constructor */
	public ICustomer0101() {
	}

	/** minimal constructor */
	public ICustomer0101(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomer0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public ICustomer0101Id() {
		}

		/** full constructor */
		public ICustomer0101Id(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomer0101Id) ) return false;
	        ICustomer0101Id castOther = (ICustomer0101Id) other;
