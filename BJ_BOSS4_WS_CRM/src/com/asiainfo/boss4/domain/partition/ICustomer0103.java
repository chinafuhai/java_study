...
/**
 * ICustomer0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_0103", schema = "ZG")
@IdClass(ICustomer0103.ICustomer0103Id.class)
public class ICustomer0103 extends ICustomer implements java.io.Serializable {
	...
	/** default constructor */
	public ICustomer0103() {
	}

	/** minimal constructor */
	public ICustomer0103(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomer0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public ICustomer0103Id() {
		}

		/** full constructor */
		public ICustomer0103Id(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomer0103Id) ) return false;
	        ICustomer0103Id castOther = (ICustomer0103Id) other;
