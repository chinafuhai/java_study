...
/**
 * ICustomer0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_0104", schema = "ZG")
@IdClass(ICustomer0104.ICustomer0104Id.class)
public class ICustomer0104 extends ICustomer implements java.io.Serializable {
	...
	/** default constructor */
	public ICustomer0104() {
	}

	/** minimal constructor */
	public ICustomer0104(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomer0104Id implements java.io.Serializable {
		...
		/** default constructor */
		public ICustomer0104Id() {
		}

		/** full constructor */
		public ICustomer0104Id(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomer0104Id) ) return false;
	        ICustomer0104Id castOther = (ICustomer0104Id) other;
