...
/**
 * ICustomer0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_0105", schema = "ZG")
@IdClass(ICustomer0105.ICustomer0105Id.class)
public class ICustomer0105 extends ICustomer implements java.io.Serializable {
	...
	/** default constructor */
	public ICustomer0105() {
	}

	/** minimal constructor */
	public ICustomer0105(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomer0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public ICustomer0105Id() {
		}

		/** full constructor */
		public ICustomer0105Id(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomer0105Id) ) return false;
	        ICustomer0105Id castOther = (ICustomer0105Id) other;
