...
/**
 * ICustomer0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_0106", schema = "ZG")
@IdClass(ICustomer0106.ICustomer0106Id.class)
public class ICustomer0106 extends ICustomer implements java.io.Serializable {
	...
	/** default constructor */
	public ICustomer0106() {
	}

	/** minimal constructor */
	public ICustomer0106(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomer0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public ICustomer0106Id() {
		}

		/** full constructor */
		public ICustomer0106Id(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomer0106Id) ) return false;
	        ICustomer0106Id castOther = (ICustomer0106Id) other;
