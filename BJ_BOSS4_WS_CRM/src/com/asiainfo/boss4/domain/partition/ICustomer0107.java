...
/**
 * ICustomer0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_0107", schema = "ZG")
@IdClass(ICustomer0107.ICustomer0107Id.class)
public class ICustomer0107 extends ICustomer implements java.io.Serializable {
	...
	/** default constructor */
	public ICustomer0107() {
	}

	/** minimal constructor */
	public ICustomer0107(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomer0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public ICustomer0107Id() {
		}

		/** full constructor */
		public ICustomer0107Id(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomer0107Id) ) return false;
	        ICustomer0107Id castOther = (ICustomer0107Id) other;
