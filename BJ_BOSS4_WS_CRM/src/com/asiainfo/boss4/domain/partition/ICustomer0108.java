...
/**
 * ICustomer0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_0108", schema = "ZG")
@IdClass(ICustomer0108.ICustomer0108Id.class)
public class ICustomer0108 extends ICustomer implements java.io.Serializable {
	...
	/** default constructor */
	public ICustomer0108() {
	}

	/** minimal constructor */
	public ICustomer0108(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomer0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public ICustomer0108Id() {
		}

		/** full constructor */
		public ICustomer0108Id(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomer0108Id) ) return false;
	        ICustomer0108Id castOther = (ICustomer0108Id) other;
