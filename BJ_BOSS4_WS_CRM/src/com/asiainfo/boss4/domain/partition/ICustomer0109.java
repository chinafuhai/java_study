...
/**
 * ICustomer0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_0109", schema = "ZG")
@IdClass(ICustomer0109.ICustomer0109Id.class)
public class ICustomer0109 extends ICustomer implements java.io.Serializable {
	...
	/** default constructor */
	public ICustomer0109() {
	}

	/** minimal constructor */
	public ICustomer0109(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomer0109Id implements java.io.Serializable {
		...
		/** default constructor */
		public ICustomer0109Id() {
		}

		/** full constructor */
		public ICustomer0109Id(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomer0109Id) ) return false;
	        ICustomer0109Id castOther = (ICustomer0109Id) other;
