...
/**
 * ICustomer0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_CUSTOMER_0110", schema = "ZG")
@IdClass(ICustomer0110.ICustomer0110Id.class)
public class ICustomer0110 extends ICustomer implements java.io.Serializable {
	...
	/** default constructor */
	public ICustomer0110() {
	}

	/** minimal constructor */
	public ICustomer0110(Long custId, Long sid, Long soNbr, String custName, Byte custType,
	...
	public static class ICustomer0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public ICustomer0110Id() {
		}

		/** full constructor */
		public ICustomer0110Id(Long custId, Long sid, Long soNbr) {
			this.custId = custId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ICustomer0110Id) ) return false;
	        ICustomer0110Id castOther = (ICustomer0110Id) other;
