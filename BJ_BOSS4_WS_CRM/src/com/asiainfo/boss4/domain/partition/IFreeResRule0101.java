...
/**
 * IFreeResRule0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_FREE_RES_RULE_0101", schema = "ZG")
@IdClass(IFreeResRule0101.IFreeResRule0101Id.class)
public class IFreeResRule0101 extends IFreeResRule implements java.io.Serializable {
	...
	/** default constructor */
	public IFreeResRule0101() {
	}

	/** minimal constructor */
	public IFreeResRule0101(Long servId, Integer prodId, Integer itemId,
	...
	public static class IFreeResRule0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public IFreeResRule0101Id() {
		}

		/** full constructor */
		public IFreeResRule0101Id(Long servId, Integer prodId, Integer itemId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IFreeResRule0101Id) ) return false;
			IFreeResRule0101Id castOther = (IFreeResRule0101Id) other;
