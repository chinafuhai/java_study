...
/**
 * IFreeResRule0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_FREE_RES_RULE_0102", schema = "ZG")
@IdClass(IFreeResRule0102.IFreeResRule0102Id.class)
public class IFreeResRule0102 extends IFreeResRule implements java.io.Serializable {
	...
	/** default constructor */
	public IFreeResRule0102() {
	}

	/** minimal constructor */
	public IFreeResRule0102(Long servId, Integer prodId, Integer itemId,
	...
	public static class IFreeResRule0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public IFreeResRule0102Id() {
		}

		/** full constructor */
		public IFreeResRule0102Id(Long servId, Integer prodId, Integer itemId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IFreeResRule0102Id) ) return false;
			IFreeResRule0102Id castOther = (IFreeResRule0102Id) other;
