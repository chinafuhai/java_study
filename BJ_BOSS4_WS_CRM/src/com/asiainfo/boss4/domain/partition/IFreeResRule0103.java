...
/**
 * IFreeResRule0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_FREE_RES_RULE_0103", schema = "ZG")
@IdClass(IFreeResRule0103.IFreeResRule0103Id.class)
public class IFreeResRule0103 extends IFreeResRule implements java.io.Serializable {
	...
	/** default constructor */
	public IFreeResRule0103() {
	}

	/** minimal constructor */
	public IFreeResRule0103(Long servId, Integer prodId, Integer itemId,
	...
	public static class IFreeResRule0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public IFreeResRule0103Id() {
		}

		/** full constructor */
		public IFreeResRule0103Id(Long servId, Integer prodId, Integer itemId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IFreeResRule0103Id) ) return false;
			IFreeResRule0103Id castOther = (IFreeResRule0103Id) other;
