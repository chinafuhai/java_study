...
/**
 * IFreeResRule0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_FREE_RES_RULE_0105", schema = "ZG")
@IdClass(IFreeResRule0105.IFreeResRule0105Id.class)
public class IFreeResRule0105 extends IFreeResRule implements java.io.Serializable {
	...
	/** default constructor */
	public IFreeResRule0105() {
	}

	/** minimal constructor */
	public IFreeResRule0105(Long servId, Integer prodId, Integer itemId,
	...
	public static class IFreeResRule0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public IFreeResRule0105Id() {
		}

		/** full constructor */
		public IFreeResRule0105Id(Long servId, Integer prodId, Integer itemId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IFreeResRule0105Id) ) return false;
			IFreeResRule0105Id castOther = (IFreeResRule0105Id) other;
