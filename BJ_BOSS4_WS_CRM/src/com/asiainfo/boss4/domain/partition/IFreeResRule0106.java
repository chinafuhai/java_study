...
/**
 * IFreeResRule0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_FREE_RES_RULE_0106", schema = "ZG")
@IdClass(IFreeResRule0106.IFreeResRule0106Id.class)
public class IFreeResRule0106 extends IFreeResRule implements java.io.Serializable {
	...
	/** default constructor */
	public IFreeResRule0106() {
	}

	/** minimal constructor */
	public IFreeResRule0106(Long servId, Integer prodId, Integer itemId,
	...
	public static class IFreeResRule0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IFreeResRule0106Id() {
		}

		/** full constructor */
		public IFreeResRule0106Id(Long servId, Integer prodId, Integer itemId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IFreeResRule0106Id) ) return false;
			IFreeResRule0106Id castOther = (IFreeResRule0106Id) other;
