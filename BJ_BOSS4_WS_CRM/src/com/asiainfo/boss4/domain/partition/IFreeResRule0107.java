...
/**
 * IFreeResRule0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_FREE_RES_RULE_0107", schema = "ZG")
@IdClass(IFreeResRule0107.IFreeResRule0107Id.class)
public class IFreeResRule0107 extends IFreeResRule implements java.io.Serializable {
	...
	/** default constructor */
	public IFreeResRule0107() {
	}

	/** minimal constructor */
	public IFreeResRule0107(Long servId, Integer prodId, Integer itemId,
	...
	public static class IFreeResRule0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IFreeResRule0107Id() {
		}

		/** full constructor */
		public IFreeResRule0107Id(Long servId, Integer prodId, Integer itemId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IFreeResRule0107Id) ) return false;
			IFreeResRule0107Id castOther = (IFreeResRule0107Id) other;
