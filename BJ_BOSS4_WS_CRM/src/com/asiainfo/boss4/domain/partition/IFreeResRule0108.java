...
/**
 * IFreeResRule0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_FREE_RES_RULE_0108", schema = "ZG")
@IdClass(IFreeResRule0108.IFreeResRule0108Id.class)
public class IFreeResRule0108 extends IFreeResRule implements java.io.Serializable {
	...
	/** default constructor */
	public IFreeResRule0108() {
	}

	/** minimal constructor */
	public IFreeResRule0108(Long servId, Integer prodId, Integer itemId,
	...
	public static class IFreeResRule0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public IFreeResRule0108Id() {
		}

		/** full constructor */
		public IFreeResRule0108Id(Long servId, Integer prodId, Integer itemId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IFreeResRule0108Id) ) return false;
			IFreeResRule0108Id castOther = (IFreeResRule0108Id) other;
