...
/**
 * IFreeResRule0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_FREE_RES_RULE_0109", schema = "ZG")
@IdClass(IFreeResRule0109.IFreeResRule0109Id.class)
public class IFreeResRule0109 extends IFreeResRule implements java.io.Serializable {
	...
	/** default constructor */
	public IFreeResRule0109() {
	}

	/** minimal constructor */
	public IFreeResRule0109(Long servId, Integer prodId, Integer itemId,
	...
	public static class IFreeResRule0109Id implements java.io.Serializable {
		...
		/** default constructor */
		public IFreeResRule0109Id() {
		}

		/** full constructor */
		public IFreeResRule0109Id(Long servId, Integer prodId, Integer itemId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IFreeResRule0109Id) ) return false;
			IFreeResRule0109Id castOther = (IFreeResRule0109Id) other;
