...
/**
 * IFreeResRule0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_FREE_RES_RULE_0110", schema = "ZG")
@IdClass(IFreeResRule0110.IFreeResRule0110Id.class)
public class IFreeResRule0110 extends IFreeResRule implements java.io.Serializable {
	...
	/** default constructor */
	public IFreeResRule0110() {
	}

	/** minimal constructor */
	public IFreeResRule0110(Long servId, Integer prodId, Integer itemId,
	...
	public static class IFreeResRule0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public IFreeResRule0110Id() {
		}

		/** full constructor */
		public IFreeResRule0110Id(Long servId, Integer prodId, Integer itemId,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IFreeResRule0110Id) ) return false;
			IFreeResRule0110Id castOther = (IFreeResRule0110Id) other;
