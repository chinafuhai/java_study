...
/**
 * IGroup0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_0101", schema = "ZG")
@IdClass(IGroup0101.IGroup0101Id.class)
public class IGroup0101 extends IGroup implements java.io.Serializable {
	...
	/** minimal constructor */
	public IGroup0101(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId, Byte sts,
	...
	/** full constructor */
	public IGroup0101(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId,
	...
	public static class IGroup0101Id implements java.io.Serializable {
		...
		/** full constructor */
		public IGroup0101Id(Long groupId, Long sid, Long soNbr) {
			this.groupId = groupId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IGroup0101Id) ) return false;
	        IGroup0101Id castOther = (IGroup0101Id) other;
