...
/**
 * IGroup0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_0102", schema = "ZG")
@IdClass(IGroup0102.IGroup0102Id.class)
public class IGroup0102 extends IGroup implements java.io.Serializable {
	...
	/** minimal constructor */
	public IGroup0102(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId, Byte sts,
	...
	/** full constructor */
	public IGroup0102(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId,
	...
	public static class IGroup0102Id implements java.io.Serializable {
		...
		/** full constructor */
		public IGroup0102Id(Long groupId, Long sid, Long soNbr) {
			this.groupId = groupId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IGroup0102Id) ) return false;
	        IGroup0102Id castOther = (IGroup0102Id) other;
