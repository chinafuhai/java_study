...
/**
 * IGroup0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_0104", schema = "ZG")
@IdClass(IGroup0104.IGroup0104Id.class)
public class IGroup0104 extends IGroup implements java.io.Serializable {
	...
	/** minimal constructor */
	public IGroup0104(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId, Byte sts,
	...
	/** full constructor */
	public IGroup0104(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId,
	...
	public static class IGroup0104Id implements java.io.Serializable {
		...
		/** full constructor */
		public IGroup0104Id(Long groupId, Long sid, Long soNbr) {
			this.groupId = groupId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IGroup0104Id) ) return false;
	        IGroup0104Id castOther = (IGroup0104Id) other;
