...
import com.asiainfo.boss4.domain.IGroup;

/**
 * IGroup0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_0106", schema = "ZG")
@IdClass(IGroup0106.IGroup0106Id.class)
public class IGroup0106 extends IGroup implements java.io.Serializable {
	...
	/** minimal constructor */
	public IGroup0106(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId, Byte sts,
	...
	/** full constructor */
	public IGroup0106(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId,
	...
	public static class IGroup0106Id implements java.io.Serializable {
		...
		/** full constructor */
		public IGroup0106Id(Long groupId, Long sid, Long soNbr) {
			this.groupId = groupId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IGroup0106Id) ) return false;
	        IGroup0106Id castOther = (IGroup0106Id) other;
