...
/**
 * IGroup0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_0107", schema = "ZG")
@IdClass(IGroup0107.IGroup0107Id.class)
public class IGroup0107 extends IGroup implements java.io.Serializable {
	...
	/** minimal constructor */
	public IGroup0107(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId, Byte sts,
	...
	/** full constructor */
	public IGroup0107(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId,
	...
	public static class IGroup0107Id implements java.io.Serializable {
		...
		/** full constructor */
		public IGroup0107Id(Long groupId, Long sid, Long soNbr) {
			this.groupId = groupId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IGroup0107Id) ) return false;
	        IGroup0107Id castOther = (IGroup0107Id) other;
