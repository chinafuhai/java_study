...
/**
 * IGroup0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_0108", schema = "ZG")
@IdClass(IGroup0108.IGroup0108Id.class)
public class IGroup0108 extends IGroup implements java.io.Serializable {
	...
	/** minimal constructor */
	public IGroup0108(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId, Byte sts,
	...
	/** full constructor */
	public IGroup0108(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId,
	...
	public static class IGroup0108Id implements java.io.Serializable {
		...
		/** full constructor */
		public IGroup0108Id(Long groupId, Long sid, Long soNbr) {
			this.groupId = groupId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IGroup0108Id) ) return false;
	        IGroup0108Id castOther = (IGroup0108Id) other;
