...
/**
 * IGroup0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_0109", schema = "ZG")
@IdClass(IGroup0109.IGroup0109Id.class)
public class IGroup0109 extends IGroup implements java.io.Serializable {
	...
	/** minimal constructor */
	public IGroup0109(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId, Byte sts,
	...
	/** full constructor */
	public IGroup0109(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId,
	...
	public static class IGroup0109Id implements java.io.Serializable {
		...
		/** full constructor */
		public IGroup0109Id(Long groupId, Long sid, Long soNbr) {
			this.groupId = groupId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IGroup0109Id) ) return false;
	        IGroup0109Id castOther = (IGroup0109Id) other;
