...
/**
 * IGroup0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_0110", schema = "ZG")
@IdClass(IGroup0110.IGroup0110Id.class)
public class IGroup0110 extends IGroup implements java.io.Serializable {
	...
	/** minimal constructor */
	public IGroup0110(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId, Byte sts,
	...
	/** full constructor */
	public IGroup0110(Long groupId, Long sid, Long soNbr, Byte groupType, Integer spromId,
	...
	public static class IGroup0110Id implements java.io.Serializable {
		...
		/** full constructor */
		public IGroup0110Id(Long groupId, Long sid, Long soNbr) {
			this.groupId = groupId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IGroup0110Id) ) return false;
	        IGroup0110Id castOther = (IGroup0110Id) other;
