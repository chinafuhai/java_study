...
/**
 * IGroupMember0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_0102", schema = "ZG")
@IdClass(IGroupMember0102.IGroupMember0102Id.class)
public class IGroupMember0102 extends IGroupMember implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMember0102() {
	}

	/** minimal constructor */
	public IGroupMember0102(Long servId, Long groupId, Date validDate, Byte groupType, Short regionCode,
	...
	/** full constructor */
	public IGroupMember0102(Long servId, Long groupId, Date validDate, Byte groupType, String property,
	...
	public static class IGroupMember0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public IGroupMember0102Id() {
		}

		/** full constructor */
		public IGroupMember0102Id(Long servId, Long groupId, Date validDate) {
			this.servId = servId;
			this.groupId = groupId;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IGroupMember0102Id) ) return false;
			IGroupMember0102Id castOther = (IGroupMember0102Id) other;
