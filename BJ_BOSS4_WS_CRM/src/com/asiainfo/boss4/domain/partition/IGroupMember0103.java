...
/**
 * IGroupMember0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_0103", schema = "ZG")
@IdClass(IGroupMember0103.IGroupMember0103Id.class)
public class IGroupMember0103 extends IGroupMember implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMember0103() {
	}

	/** minimal constructor */
	public IGroupMember0103(Long servId, Long groupId, Date validDate, Byte groupType, Short regionCode,
	...
	/** full constructor */
	public IGroupMember0103(Long servId, Long groupId, Date validDate, Byte groupType, String property,
	...
	public static class IGroupMember0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public IGroupMember0103Id() {
		}

		/** full constructor */
		public IGroupMember0103Id(Long servId, Long groupId, Date validDate) {
			this.servId = servId;
			this.groupId = groupId;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IGroupMember0103Id) ) return false;
			IGroupMember0103Id castOther = (IGroupMember0103Id) other;
