...
/**
 * IGroupMember0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_0104", schema = "ZG")
@IdClass(IGroupMember0104.IGroupMember0104Id.class)
public class IGroupMember0104 extends IGroupMember implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMember0104() {
	}

	/** minimal constructor */
	public IGroupMember0104(Long servId, Long groupId, Date validDate, Byte groupType, Short regionCode,
	...
	/** full constructor */
	public IGroupMember0104(Long servId, Long groupId, Date validDate, Byte groupType, String property,
	...
	public static class IGroupMember0104Id implements java.io.Serializable {
		...
		/** default constructor */
		public IGroupMember0104Id() {
		}

		/** full constructor */
		public IGroupMember0104Id(Long servId, Long groupId, Date validDate) {
			this.servId = servId;
			this.groupId = groupId;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IGroupMember0104Id) ) return false;
			IGroupMember0104Id castOther = (IGroupMember0104Id) other;
