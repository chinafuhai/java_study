...
/**
 * IGroupMember0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_0105", schema = "ZG")
@IdClass(IGroupMember0105.IGroupMember0105Id.class)
public class IGroupMember0105 extends IGroupMember implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMember0105() {
	}

	/** minimal constructor */
	public IGroupMember0105(Long servId, Long groupId, Date validDate, Byte groupType, Short regionCode,
	...
	/** full constructor */
	public IGroupMember0105(Long servId, Long groupId, Date validDate, Byte groupType, String property,
	...
	public static class IGroupMember0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public IGroupMember0105Id() {
		}

		/** full constructor */
		public IGroupMember0105Id(Long servId, Long groupId, Date validDate) {
			this.servId = servId;
			this.groupId = groupId;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IGroupMember0105Id) ) return false;
			IGroupMember0105Id castOther = (IGroupMember0105Id) other;
