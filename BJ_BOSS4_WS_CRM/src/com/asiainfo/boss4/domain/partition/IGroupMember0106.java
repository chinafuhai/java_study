...
/**
 * IGroupMember0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_0106", schema = "ZG")
@IdClass(IGroupMember0106.IGroupMember0106Id.class)
public class IGroupMember0106 extends IGroupMember implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMember0106() {
	}

	/** minimal constructor */
	public IGroupMember0106(Long servId, Long groupId, Date validDate, Byte groupType, Short regionCode,
	...
	/** full constructor */
	public IGroupMember0106(Long servId, Long groupId, Date validDate, Byte groupType, String property,
	...
	public static class IGroupMember0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IGroupMember0106Id() {
		}

		/** full constructor */
		public IGroupMember0106Id(Long servId, Long groupId, Date validDate) {
			this.servId = servId;
			this.groupId = groupId;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IGroupMember0106Id) ) return false;
			IGroupMember0106Id castOther = (IGroupMember0106Id) other;
