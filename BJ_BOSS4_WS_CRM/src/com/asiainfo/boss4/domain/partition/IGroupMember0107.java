...
/**
 * IGroupMember0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_0107", schema = "ZG")
@IdClass(IGroupMember0107.IGroupMember0107Id.class)
public class IGroupMember0107 extends IGroupMember implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMember0107() {
	}

	/** minimal constructor */
	public IGroupMember0107(Long servId, Long groupId, Date validDate, Byte groupType, Short regionCode,
	...
	/** full constructor */
	public IGroupMember0107(Long servId, Long groupId, Date validDate, Byte groupType, String property,
	...
	public static class IGroupMember0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IGroupMember0107Id() {
		}

		/** full constructor */
		public IGroupMember0107Id(Long servId, Long groupId, Date validDate) {
			this.servId = servId;
			this.groupId = groupId;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IGroupMember0107Id) ) return false;
			IGroupMember0107Id castOther = (IGroupMember0107Id) other;
