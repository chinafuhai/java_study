...
/**
 * IGroupMember0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_0108", schema = "ZG")
@IdClass(IGroupMember0108.IGroupMember0108Id.class)
public class IGroupMember0108 extends IGroupMember implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMember0108() {
	}

	/** minimal constructor */
	public IGroupMember0108(Long servId, Long groupId, Date validDate, Byte groupType, Short regionCode,
	...
	/** full constructor */
	public IGroupMember0108(Long servId, Long groupId, Date validDate, Byte groupType, String property,
	...
	public static class IGroupMember0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public IGroupMember0108Id() {
		}

		/** full constructor */
		public IGroupMember0108Id(Long servId, Long groupId, Date validDate) {
			this.servId = servId;
			this.groupId = groupId;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IGroupMember0108Id) ) return false;
			IGroupMember0108Id castOther = (IGroupMember0108Id) other;
