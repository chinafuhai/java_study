...
/**
 * IGroupMember0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_0109", schema = "ZG")
@IdClass(IGroupMember0109.IGroupMember0109Id.class)
public class IGroupMember0109 extends IGroupMember implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMember0109() {
	}

	/** minimal constructor */
	public IGroupMember0109(Long servId, Long groupId, Date validDate, Byte groupType, Short regionCode,
	...
	/** full constructor */
	public IGroupMember0109(Long servId, Long groupId, Date validDate, Byte groupType, String property,
	...
	public static class IGroupMember0109Id implements java.io.Serializable {
		...
		/** default constructor */
		public IGroupMember0109Id() {
		}

		/** full constructor */
		public IGroupMember0109Id(Long servId, Long groupId, Date validDate) {
			this.servId = servId;
			this.groupId = groupId;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IGroupMember0109Id) ) return false;
			IGroupMember0109Id castOther = (IGroupMember0109Id) other;
