...
/**
 * IGroupMember0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_0110", schema = "ZG")
@IdClass(IGroupMember0110.IGroupMember0110Id.class)
public class IGroupMember0110 extends IGroupMember implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMember0110() {
	}

	/** minimal constructor */
	public IGroupMember0110(Long servId, Long groupId, Date validDate, Byte groupType, Short regionCode,
	...
	/** full constructor */
	public IGroupMember0110(Long servId, Long groupId, Date validDate, Byte groupType, String property,
	...
	public static class IGroupMember0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public IGroupMember0110Id() {
		}

		/** full constructor */
		public IGroupMember0110Id(Long servId, Long groupId, Date validDate) {
			this.servId = servId;
			this.groupId = groupId;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IGroupMember0110Id) ) return false;
			IGroupMember0110Id castOther = (IGroupMember0110Id) other;
