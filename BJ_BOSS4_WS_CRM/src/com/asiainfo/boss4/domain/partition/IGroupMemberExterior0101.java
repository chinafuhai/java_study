...
/**
 * IGroupMemberExterior0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_EXTERIOR_0101", schema = "ZG")
public class IGroupMemberExterior0101 extends IGroupMemberExterior implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMemberExterior0101() {
	}

	/** minimal constructor */
	public IGroupMemberExterior0101(String phoneNumber, Long groupId,
	...
	/** full constructor */
	public IGroupMemberExterior0101(String phoneNumber, Byte groupType,
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IGroupMemberExterior0101) ) return false;
		IGroupMemberExterior0101 castOther = (IGroupMemberExterior0101) other;
