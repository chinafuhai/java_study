...
/**
 * IGroupMemberExterior0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_EXTERIOR_0102", schema = "ZG")
public class IGroupMemberExterior0102 extends IGroupMemberExterior implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMemberExterior0102() {
	}

	/** minimal constructor */
	public IGroupMemberExterior0102(String phoneNumber, Long groupId,
	...
	/** full constructor */
	public IGroupMemberExterior0102(String phoneNumber, Byte groupType,
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IGroupMemberExterior0102) ) return false;
		IGroupMemberExterior0102 castOther = (IGroupMemberExterior0102) other;
