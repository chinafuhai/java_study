...
/**
 * IGroupMemberExterior0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_EXTERIOR_0103", schema = "ZG")
public class IGroupMemberExterior0103 extends IGroupMemberExterior implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMemberExterior0103() {
	}

	/** minimal constructor */
	public IGroupMemberExterior0103(String phoneNumber, Long groupId,
	...
	/** full constructor */
	public IGroupMemberExterior0103(String phoneNumber, Byte groupType,
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IGroupMemberExterior0103) ) return false;
		IGroupMemberExterior0103 castOther = (IGroupMemberExterior0103) other;
