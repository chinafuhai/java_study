...
/**
 * IGroupMemberExterior0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_EXTERIOR_0104", schema = "ZG")
public class IGroupMemberExterior0104 extends IGroupMemberExterior implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMemberExterior0104() {
	}

	/** minimal constructor */
	public IGroupMemberExterior0104(String phoneNumber, Long groupId,
	...
	/** full constructor */
	public IGroupMemberExterior0104(String phoneNumber, Byte groupType,
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IGroupMemberExterior0104) ) return false;
		IGroupMemberExterior0104 castOther = (IGroupMemberExterior0104) other;
