...
/**
 * IGroupMemberExterior0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_EXTERIOR_0105", schema = "ZG")
public class IGroupMemberExterior0105 extends IGroupMemberExterior implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMemberExterior0105() {
	}

	/** minimal constructor */
	public IGroupMemberExterior0105(String phoneNumber, Long groupId,
	...
	/** full constructor */
	public IGroupMemberExterior0105(String phoneNumber, Byte groupType,
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IGroupMemberExterior0105) ) return false;
		IGroupMemberExterior0105 castOther = (IGroupMemberExterior0105) other;
