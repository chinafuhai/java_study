...
/**
 * IGroupMemberExterior0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_EXTERIOR_0106", schema = "ZG")
public class IGroupMemberExterior0106 extends IGroupMemberExterior implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMemberExterior0106() {
	}

	/** minimal constructor */
	public IGroupMemberExterior0106(String phoneNumber, Long groupId,
	...
	/** full constructor */
	public IGroupMemberExterior0106(String phoneNumber, Byte groupType,
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IGroupMemberExterior0106) ) return false;
		IGroupMemberExterior0106 castOther = (IGroupMemberExterior0106) other;
