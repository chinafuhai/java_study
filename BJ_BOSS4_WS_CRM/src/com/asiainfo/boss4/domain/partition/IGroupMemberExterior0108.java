...
/**
 * IGroupMemberExterior0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_EXTERIOR_0108", schema = "ZG")
public class IGroupMemberExterior0108 extends IGroupMemberExterior implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMemberExterior0108() {
	}

	/** minimal constructor */
	public IGroupMemberExterior0108(String phoneNumber, Long groupId,
	...
	/** full constructor */
	public IGroupMemberExterior0108(String phoneNumber, Byte groupType,
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IGroupMemberExterior0108) ) return false;
		IGroupMemberExterior0108 castOther = (IGroupMemberExterior0108) other;
