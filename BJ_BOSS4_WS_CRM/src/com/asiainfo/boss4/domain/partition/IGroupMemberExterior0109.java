...
/**
 * IGroupMemberExterior0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_EXTERIOR_0109", schema = "ZG")
public class IGroupMemberExterior0109 extends IGroupMemberExterior implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMemberExterior0109() {
	}

	/** minimal constructor */
	public IGroupMemberExterior0109(String phoneNumber, Long groupId,
	...
	/** full constructor */
	public IGroupMemberExterior0109(String phoneNumber, Byte groupType,
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IGroupMemberExterior0109) ) return false;
		IGroupMemberExterior0109 castOther = (IGroupMemberExterior0109) other;
