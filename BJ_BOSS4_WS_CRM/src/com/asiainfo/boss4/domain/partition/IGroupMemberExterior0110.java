...
/**
 * IGroupMemberExterior0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_GROUP_MEMBER_EXTERIOR_0110", schema = "ZG")
public class IGroupMemberExterior0110 extends IGroupMemberExterior implements java.io.Serializable {
	...
	/** default constructor */
	public IGroupMemberExterior0110() {
	}

	/** minimal constructor */
	public IGroupMemberExterior0110(String phoneNumber, Long groupId,
	...
	/** full constructor */
	public IGroupMemberExterior0110(String phoneNumber, Byte groupType,
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IGroupMemberExterior0110) ) return false;
		IGroupMemberExterior0110 castOther = (IGroupMemberExterior0110) other;
