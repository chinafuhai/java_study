...
/**
 * IRaccOper0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER_0101", schema = "ZG")
public class IRaccOper0101 extends IRaccOper implements java.io.Serializable {
	...
	/** default constructor */
	public IRaccOper0101() {
	}

	/** minimal constructor */
	public IRaccOper0101(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper0101) ) return false;
        IRaccOper0101 castOther = (IRaccOper0101) other;
