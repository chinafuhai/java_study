...
/**
 * IRaccOper0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER_0102", schema = "ZG")
public class IRaccOper0102 extends IRaccOper implements java.io.Serializable {
	...
	/** default constructor */
	public IRaccOper0102() {
	}

	/** minimal constructor */
	public IRaccOper0102(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper0102) ) return false;
        IRaccOper0102 castOther = (IRaccOper0102) other;
