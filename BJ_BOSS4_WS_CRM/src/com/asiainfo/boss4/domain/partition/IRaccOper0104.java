...
/**
 * IRaccOper0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER_0104", schema = "ZG")
public class IRaccOper0104 extends IRaccOper implements java.io.Serializable {
	...
	/** default constructor */
	public IRaccOper0104() {
	}

	/** minimal constructor */
	public IRaccOper0104(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper0104) ) return false;
        IRaccOper0104 castOther = (IRaccOper0104) other;
