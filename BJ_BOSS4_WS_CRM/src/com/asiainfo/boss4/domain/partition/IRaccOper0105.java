...
/**
 * IRaccOper0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER_0105", schema = "ZG")
public class IRaccOper0105 extends IRaccOper implements java.io.Serializable {
	...
	/** default constructor */
	public IRaccOper0105() {
	}

	/** minimal constructor */
	public IRaccOper0105(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper0105) ) return false;
        IRaccOper0105 castOther = (IRaccOper0105) other;
