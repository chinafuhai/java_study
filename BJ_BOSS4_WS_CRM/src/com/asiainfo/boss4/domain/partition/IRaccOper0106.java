...
/**
 * IRaccOper0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER_0106", schema = "ZG")
public class IRaccOper0106 extends IRaccOper implements java.io.Serializable {
	...
	/** default constructor */
	public IRaccOper0106() {
	}

	/** minimal constructor */
	public IRaccOper0106(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper0106) ) return false;
        IRaccOper0106 castOther = (IRaccOper0106) other;
