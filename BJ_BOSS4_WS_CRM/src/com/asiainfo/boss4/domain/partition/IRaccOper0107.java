...
/**
 * IRaccOper0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER_0107", schema = "ZG")
public class IRaccOper0107 extends IRaccOper implements java.io.Serializable {
	...
	/** default constructor */
	public IRaccOper0107() {
	}

	/** minimal constructor */
	public IRaccOper0107(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper0107) ) return false;
        IRaccOper0107 castOther = (IRaccOper0107) other;
