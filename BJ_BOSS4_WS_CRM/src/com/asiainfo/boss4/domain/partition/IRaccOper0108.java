...
/**
 * IRaccOper0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER_0108", schema = "ZG")
public class IRaccOper0108 extends IRaccOper implements java.io.Serializable {
	...
	/** default constructor */
	public IRaccOper0108() {
	}

	/** minimal constructor */
	public IRaccOper0108(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper0108) ) return false;
        IRaccOper0108 castOther = (IRaccOper0108) other;
