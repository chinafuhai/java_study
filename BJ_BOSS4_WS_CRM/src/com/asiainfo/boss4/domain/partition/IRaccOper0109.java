...
/**
 * IRaccOper0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER_0109", schema = "ZG")
public class IRaccOper0109 extends IRaccOper implements java.io.Serializable {
	...
	/** default constructor */
	public IRaccOper0109() {
	}

	/** minimal constructor */
	public IRaccOper0109(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper0109) ) return false;
        IRaccOper0109 castOther = (IRaccOper0109) other;
