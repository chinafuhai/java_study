...
/**
 * IRaccOper0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_RACC_OPER_0110", schema = "ZG")
public class IRaccOper0110 extends IRaccOper implements java.io.Serializable {
	...
	/** default constructor */
	public IRaccOper0110() {
	}

	/** minimal constructor */
	public IRaccOper0110(Long sid, Long soNbr, Integer busiCode,
	...
	public boolean equals(Object other) {
        if ( !(other instanceof IRaccOper0110) ) return false;
        IRaccOper0110 castOther = (IRaccOper0110) other;
