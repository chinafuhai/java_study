...
/**
 * ISaleOper0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SALE_OPER_0101", schema = "ZG")
public class ISaleOper0101 extends ISaleOper implements java.io.Serializable {
	...
	/** default constructor */
	public ISaleOper0101() {
	}

	/** minimal constructor */
	public ISaleOper0101(Long sid, Long soNbr, Integer busiCode,
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ISaleOper0101) ) return false;
        ISaleOper0101 castOther = (ISaleOper0101) other;
