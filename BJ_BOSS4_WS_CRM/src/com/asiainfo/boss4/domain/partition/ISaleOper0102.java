...
/**
 * ISaleOper0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SALE_OPER_0102", schema = "ZG")
public class ISaleOper0102 extends ISaleOper implements java.io.Serializable {
	...
	/** default constructor */
	public ISaleOper0102() {
	}

	/** minimal constructor */
	public ISaleOper0102(Long sid, Long soNbr, Integer busiCode,
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ISaleOper0102) ) return false;
        ISaleOper0102 castOther = (ISaleOper0102) other;
