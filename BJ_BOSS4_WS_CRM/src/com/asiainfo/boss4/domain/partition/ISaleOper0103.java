...
/**
 * ISaleOper0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SALE_OPER_0103", schema = "ZG")
public class ISaleOper0103 extends ISaleOper implements java.io.Serializable {
	...
	/** default constructor */
	public ISaleOper0103() {
	}

	/** minimal constructor */
	public ISaleOper0103(Long sid, Long soNbr, Integer busiCode,
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ISaleOper0103) ) return false;
        ISaleOper0103 castOther = (ISaleOper0103) other;
