...
/**
 * ISaleOper0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SALE_OPER_0104", schema = "ZG")
public class ISaleOper0104 extends ISaleOper implements java.io.Serializable {
	...
	/** default constructor */
	public ISaleOper0104() {
	}

	/** minimal constructor */
	public ISaleOper0104(Long sid, Long soNbr, Integer busiCode,
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ISaleOper0104) ) return false;
        ISaleOper0104 castOther = (ISaleOper0104) other;
