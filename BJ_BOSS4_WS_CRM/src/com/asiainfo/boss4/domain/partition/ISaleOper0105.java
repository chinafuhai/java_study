...
/**
 * ISaleOper0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SALE_OPER_0105", schema = "ZG")
public class ISaleOper0105 extends ISaleOper implements java.io.Serializable {
	...
	/** default constructor */
	public ISaleOper0105() {
	}

	/** minimal constructor */
	public ISaleOper0105(Long sid, Long soNbr, Integer busiCode,
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ISaleOper0105) ) return false;
        ISaleOper0105 castOther = (ISaleOper0105) other;
