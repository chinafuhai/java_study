...
/**
 * ISaleOper0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SALE_OPER_0107", schema = "ZG")
public class ISaleOper0107 extends ISaleOper implements java.io.Serializable {
	...
	/** default constructor */
	public ISaleOper0107() {
	}

	/** minimal constructor */
	public ISaleOper0107(Long sid, Long soNbr, Integer busiCode,
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ISaleOper0107) ) return false;
        ISaleOper0107 castOther = (ISaleOper0107) other;
