...
/**
 * ISaleOper0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SALE_OPER_0108", schema = "ZG")
public class ISaleOper0108 extends ISaleOper implements java.io.Serializable {
	...
	/** default constructor */
	public ISaleOper0108() {
	}

	/** minimal constructor */
	public ISaleOper0108(Long sid, Long soNbr, Integer busiCode,
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ISaleOper0108) ) return false;
        ISaleOper0108 castOther = (ISaleOper0108) other;
