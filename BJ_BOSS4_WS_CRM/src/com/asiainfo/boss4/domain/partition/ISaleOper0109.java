...
/**
 * ISaleOper0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SALE_OPER_0109", schema = "ZG")
public class ISaleOper0109 extends ISaleOper implements java.io.Serializable {
	...
	/** default constructor */
	public ISaleOper0109() {
	}

	/** minimal constructor */
	public ISaleOper0109(Long sid, Long soNbr, Integer busiCode,
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ISaleOper0109) ) return false;
        ISaleOper0109 castOther = (ISaleOper0109) other;
