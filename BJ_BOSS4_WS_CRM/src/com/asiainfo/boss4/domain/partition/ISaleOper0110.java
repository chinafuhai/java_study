...
/**
 * ISaleOper0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SALE_OPER_0110", schema = "ZG")
public class ISaleOper0110 extends ISaleOper implements java.io.Serializable {
	...
	/** default constructor */
	public ISaleOper0110() {
	}

	/** minimal constructor */
	public ISaleOper0110(Long sid, Long soNbr, Integer busiCode,
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ISaleOper0110) ) return false;
        ISaleOper0110 castOther = (ISaleOper0110) other;
