...
/**
 * ISpromParam0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SPROM_PARAM_0101", schema = "ZG")
@IdClass(ISpromParam0101.ISpromParam0101Id.class)
public class ISpromParam0101 extends ISpromParam implements java.io.Serializable {
	...
	/** default constructor */
	public ISpromParam0101() {
	}

	/** minimal constructor */
	public ISpromParam0101(Long servId,	Date validDate, Long soId, Date expireDate, Long sid,
			Long soNbr) {
		this.servId = servId;
	...
	/** full constructor */
	public ISpromParam0101(Long servId, Integer keyId,
	...
	public static class ISpromParam0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public ISpromParam0101Id() {
		}

		/** full constructor */
		public ISpromParam0101Id(Long servId, Integer keyId, Date validDate,
				Long soId) {
			this.servId = servId;
			this.keyId = keyId;
			this.validDate = validDate;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ISpromParam0101Id) ) return false;
	        ISpromParam0101Id castOther = (ISpromParam0101Id) other;
