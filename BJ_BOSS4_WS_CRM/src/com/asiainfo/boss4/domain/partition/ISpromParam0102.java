...
/**
 * ISpromParam0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SPROM_PARAM_0102", schema = "ZG")
@IdClass(ISpromParam0102.ISpromParam0102Id.class)
public class ISpromParam0102 extends ISpromParam implements java.io.Serializable {
	...
	/** default constructor */
	public ISpromParam0102() {
	}

	/** minimal constructor */
	public ISpromParam0102(Long servId,	Date validDate, Long soId, Date expireDate, Long sid,
			Long soNbr) {
		this.servId = servId;
	...
	/** full constructor */
	public ISpromParam0102(Long servId, Integer keyId,
	...
	public static class ISpromParam0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public ISpromParam0102Id() {
		}

		/** full constructor */
		public ISpromParam0102Id(Long servId, Integer keyId, Date validDate,
				Long soId) {
			this.servId = servId;
			this.keyId = keyId;
			this.validDate = validDate;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ISpromParam0102Id) ) return false;
	        ISpromParam0102Id castOther = (ISpromParam0102Id) other;
