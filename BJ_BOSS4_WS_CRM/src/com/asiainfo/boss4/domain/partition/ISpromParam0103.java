...
/**
 * ISpromParam0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SPROM_PARAM_0103", schema = "ZG")
@IdClass(ISpromParam0103.ISpromParam0103Id.class)
public class ISpromParam0103 extends ISpromParam implements java.io.Serializable {
	...
	/** default constructor */
	public ISpromParam0103() {
	}

	/** minimal constructor */
	public ISpromParam0103(Long servId,	Date validDate, Long soId, Date expireDate, Long sid,
			Long soNbr) {
		this.servId = servId;
	...
	/** full constructor */
	public ISpromParam0103(Long servId, Integer keyId,
	...
	public static class ISpromParam0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public ISpromParam0103Id() {
		}

		/** full constructor */
		public ISpromParam0103Id(Long servId, Integer keyId, Date validDate,
				Long soId) {
			this.servId = servId;
			this.keyId = keyId;
			this.validDate = validDate;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ISpromParam0103Id) ) return false;
	        ISpromParam0103Id castOther = (ISpromParam0103Id) other;
