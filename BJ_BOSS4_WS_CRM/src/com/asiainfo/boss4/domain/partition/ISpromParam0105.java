...
/**
 * ISpromParam0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SPROM_PARAM_0105", schema = "ZG")
@IdClass(ISpromParam0105.ISpromParam0105Id.class)
public class ISpromParam0105 extends ISpromParam implements java.io.Serializable {
	...
	/** default constructor */
	public ISpromParam0105() {
	}

	/** minimal constructor */
	public ISpromParam0105(Long servId,	Date validDate, Long soId, Date expireDate, Long sid,
			Long soNbr) {
		this.servId = servId;
	...
	/** full constructor */
	public ISpromParam0105(Long servId, Integer keyId,
	...
	public static class ISpromParam0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public ISpromParam0105Id() {
		}

		/** full constructor */
		public ISpromParam0105Id(Long servId, Integer keyId, Date validDate,
				Long soId) {
			this.servId = servId;
			this.keyId = keyId;
			this.validDate = validDate;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ISpromParam0105Id) ) return false;
	        ISpromParam0105Id castOther = (ISpromParam0105Id) other;
