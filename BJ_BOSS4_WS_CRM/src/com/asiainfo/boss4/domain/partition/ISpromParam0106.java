...
/**
 * ISpromParam0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SPROM_PARAM_0106", schema = "ZG")
@IdClass(ISpromParam0106.ISpromParam0106Id.class)
public class ISpromParam0106 extends ISpromParam implements java.io.Serializable {
	...
	/** default constructor */
	public ISpromParam0106() {
	}

	/** minimal constructor */
	public ISpromParam0106(Long servId,	Date validDate, Long soId, Date expireDate, Long sid,
			Long soNbr) {
		this.servId = servId;
	...
	/** full constructor */
	public ISpromParam0106(Long servId, Integer keyId,
	...
	public static class ISpromParam0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public ISpromParam0106Id() {
		}

		/** full constructor */
		public ISpromParam0106Id(Long servId, Integer keyId, Date validDate,
				Long soId) {
			this.servId = servId;
			this.keyId = keyId;
			this.validDate = validDate;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ISpromParam0106Id) ) return false;
	        ISpromParam0106Id castOther = (ISpromParam0106Id) other;
