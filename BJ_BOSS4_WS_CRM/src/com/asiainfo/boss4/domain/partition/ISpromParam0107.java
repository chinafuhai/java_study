...
/**
 * ISpromParam0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SPROM_PARAM_0107", schema = "ZG")
@IdClass(ISpromParam0107.ISpromParam0107Id.class)
public class ISpromParam0107 extends ISpromParam implements java.io.Serializable {
	...
	/** default constructor */
	public ISpromParam0107() {
	}

	/** minimal constructor */
	public ISpromParam0107(Long servId,	Date validDate, Long soId, Date expireDate, Long sid,
			Long soNbr) {
		this.servId = servId;
	...
	/** full constructor */
	public ISpromParam0107(Long servId, Integer keyId,
	...
	public static class ISpromParam0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public ISpromParam0107Id() {
		}

		/** full constructor */
		public ISpromParam0107Id(Long servId, Integer keyId, Date validDate,
				Long soId) {
			this.servId = servId;
			this.keyId = keyId;
			this.validDate = validDate;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ISpromParam0107Id) ) return false;
	        ISpromParam0107Id castOther = (ISpromParam0107Id) other;
