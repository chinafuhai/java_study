...
/**
 * ISpromParam0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SPROM_PARAM_0108", schema = "ZG")
@IdClass(ISpromParam0108.ISpromParam0108Id.class)
public class ISpromParam0108 extends ISpromParam implements java.io.Serializable {
	...
	/** default constructor */
	public ISpromParam0108() {
	}

	/** minimal constructor */
	public ISpromParam0108(Long servId,	Date validDate, Long soId, Date expireDate, Long sid,
			Long soNbr) {
		this.servId = servId;
	...
	/** full constructor */
	public ISpromParam0108(Long servId, Integer keyId,
	...
	public static class ISpromParam0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public ISpromParam0108Id() {
		}

		/** full constructor */
		public ISpromParam0108Id(Long servId, Integer keyId, Date validDate,
				Long soId) {
			this.servId = servId;
			this.keyId = keyId;
			this.validDate = validDate;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ISpromParam0108Id) ) return false;
	        ISpromParam0108Id castOther = (ISpromParam0108Id) other;
