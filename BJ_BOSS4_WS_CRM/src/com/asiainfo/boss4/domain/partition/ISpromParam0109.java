...
/**
 * ISpromParam0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SPROM_PARAM_0109", schema = "ZG")
@IdClass(ISpromParam0109.ISpromParam0109Id.class)
public class ISpromParam0109 extends ISpromParam implements java.io.Serializable {
	...
	/** default constructor */
	public ISpromParam0109() {
	}

	/** minimal constructor */
	public ISpromParam0109(Long servId,	Date validDate, Long soId, Date expireDate, Long sid,
			Long soNbr) {
		this.servId = servId;
	...
	/** full constructor */
	public ISpromParam0109(Long servId, Integer keyId,
	...
	public static class ISpromParam0109Id implements java.io.Serializable {
		...
		/** default constructor */
		public ISpromParam0109Id() {
		}

		/** full constructor */
		public ISpromParam0109Id(Long servId, Integer keyId, Date validDate,
				Long soId) {
			this.servId = servId;
			this.keyId = keyId;
			this.validDate = validDate;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ISpromParam0109Id) ) return false;
	        ISpromParam0109Id castOther = (ISpromParam0109Id) other;
