...
/**
 * ISpromParam0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_SPROM_PARAM_0110", schema = "ZG")
@IdClass(ISpromParam0110.ISpromParam0110Id.class)
public class ISpromParam0110 extends ISpromParam implements java.io.Serializable {
	...
	/** default constructor */
	public ISpromParam0110() {
	}

	/** minimal constructor */
	public ISpromParam0110(Long servId,	Date validDate, Long soId, Date expireDate, Long sid,
			Long soNbr) {
		this.servId = servId;
	...
	/** full constructor */
	public ISpromParam0110(Long servId, Integer keyId,
	...
	public static class ISpromParam0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public ISpromParam0110Id() {
		}

		/** full constructor */
		public ISpromParam0110Id(Long servId, Integer keyId, Date validDate,
				Long soId) {
			this.servId = servId;
			this.keyId = keyId;
			this.validDate = validDate;
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof ISpromParam0110Id) ) return false;
	        ISpromParam0110Id castOther = (ISpromParam0110Id) other;
