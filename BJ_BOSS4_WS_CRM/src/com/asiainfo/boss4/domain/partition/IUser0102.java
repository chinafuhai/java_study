...
/**
 * IUser0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_0102", schema = "ZG")
@IdClass(IUser0102.IUser0102Id.class)
public class IUser0102 extends IUser implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUser0102(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
	...
	public static class IUser0102Id implements java.io.Serializable {
		// Fields
		...
		/** full constructor */
		public IUser0102Id(Long servId, Date validDate, Long sid, Long soNbr) {
			this.servId = servId;
			this.validDate = validDate;
			this.sid = sid;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUser0102Id))
				return false;
			IUser0102Id castOther = (IUser0102Id) other;
