...
/**
 * IUser0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_0103", schema = "ZG")
@IdClass(IUser0103.IUser0103Id.class)
public class IUser0103 extends IUser implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUser0103(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
	...
	public static class IUser0103Id implements java.io.Serializable {
		// Fields
		...
		/** full constructor */
		public IUser0103Id(Long servId, Date validDate, Long sid, Long soNbr) {
			this.servId = servId;
			this.validDate = validDate;
			this.sid = sid;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUser0103Id))
				return false;
			IUser0103Id castOther = (IUser0103Id) other;
