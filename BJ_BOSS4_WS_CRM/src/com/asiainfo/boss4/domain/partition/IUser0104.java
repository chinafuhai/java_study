...
/**
 * IUser0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_0104", schema = "ZG")
@IdClass(IUser0104.IUser0104Id.class)
public class IUser0104 extends IUser implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUser0104(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
	...
	public static class IUser0104Id implements java.io.Serializable {
		// Fields
		...
		/** full constructor */
		public IUser0104Id(Long servId, Date validDate, Long sid, Long soNbr) {
			this.servId = servId;
			this.validDate = validDate;
			this.sid = sid;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUser0104Id))
				return false;
			IUser0104Id castOther = (IUser0104Id) other;
