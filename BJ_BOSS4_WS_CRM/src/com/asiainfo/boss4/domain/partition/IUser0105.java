...
/**
 * IUser0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_0105", schema = "ZG")
@IdClass(IUser0105.IUser0105Id.class)
public class IUser0105 extends IUser implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUser0105(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
	...
	public static class IUser0105Id implements java.io.Serializable {
		// Fields
		...
		/** full constructor */
		public IUser0105Id(Long servId, Date validDate, Long sid, Long soNbr) {
			this.servId = servId;
			this.validDate = validDate;
			this.sid = sid;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUser0105Id))
				return false;
			IUser0105Id castOther = (IUser0105Id) other;
