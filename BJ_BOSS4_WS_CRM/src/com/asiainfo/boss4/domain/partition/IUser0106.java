...
/**
 * IUser0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_0106", schema = "ZG")
@IdClass(IUser0106.IUser0106Id.class)
public class IUser0106 extends IUser implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUser0106(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
	...
	public static class IUser0106Id implements java.io.Serializable {
		// Fields
		...
		/** full constructor */
		public IUser0106Id(Long servId, Date validDate, Long sid, Long soNbr) {
			this.servId = servId;
			this.validDate = validDate;
			this.sid = sid;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUser0106Id))
				return false;
			IUser0106Id castOther = (IUser0106Id) other;
