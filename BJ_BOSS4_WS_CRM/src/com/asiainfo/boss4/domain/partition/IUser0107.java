...
/**
 * IUser0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_0107", schema = "ZG")
@IdClass(IUser0107.IUser0107Id.class)
public class IUser0107 extends IUser implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUser0107(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
	...
	public static class IUser0107Id implements java.io.Serializable {
		// Fields
		...
		/** full constructor */
		public IUser0107Id(Long servId, Date validDate, Long sid, Long soNbr) {
			this.servId = servId;
			this.validDate = validDate;
			this.sid = sid;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUser0107Id))
				return false;
			IUser0107Id castOther = (IUser0107Id) other;
