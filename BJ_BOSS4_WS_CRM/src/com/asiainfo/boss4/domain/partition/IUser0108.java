...
/**
 * IUser0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_0108", schema = "ZG")
@IdClass(IUser0108.IUser0108Id.class)
public class IUser0108 extends IUser implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUser0108(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
	...
	public static class IUser0108Id implements java.io.Serializable {
		// Fields
		...
		/** full constructor */
		public IUser0108Id(Long servId, Date validDate, Long sid, Long soNbr) {
			this.servId = servId;
			this.validDate = validDate;
			this.sid = sid;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUser0108Id))
				return false;
			IUser0108Id castOther = (IUser0108Id) other;
