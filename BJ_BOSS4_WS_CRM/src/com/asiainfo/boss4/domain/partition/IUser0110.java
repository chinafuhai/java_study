...
/**
 * IUser0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_0110", schema = "ZG")
@IdClass(IUser0110.IUser0110Id.class)
public class IUser0110 extends IUser implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUser0110(Long servId, Date validDate, Long sid, Long soNbr, String msisdn, String imsi, Long acctId,
	...
	public static class IUser0110Id implements java.io.Serializable {
		// Fields
		...
		/** full constructor */
		public IUser0110Id(Long servId, Date validDate, Long sid, Long soNbr) {
			this.servId = servId;
			this.validDate = validDate;
			this.sid = sid;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUser0110Id))
				return false;
			IUser0110Id castOther = (IUser0110Id) other;
