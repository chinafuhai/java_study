...
/**
 * IUserBillCycle0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_BILL_CYCLE_0101", schema = "ZG")
@IdClass(IUserBillCycle0101.IUserBillCycle0101Id.class)
public class IUserBillCycle0101 extends IUserBillCycle implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycle0101() {
	}

	/** minimal constructor */
	public IUserBillCycle0101(Long servId, Long soNbr, Short regionCode,
	...
	public static class IUserBillCycle0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycle0101Id() {
		}

		/** full constructor */
		public IUserBillCycle0101Id(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycle0101Id) ) return false;
			IUserBillCycle0101Id castOther = (IUserBillCycle0101Id) other;
