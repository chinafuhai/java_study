...
/**
 * IUserBillCycle0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_BILL_CYCLE_0102", schema = "ZG")
@IdClass(IUserBillCycle0102.IUserBillCycle0102Id.class)
public class IUserBillCycle0102 extends IUserBillCycle implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycle0102() {
	}

	/** minimal constructor */
	public IUserBillCycle0102(Long servId, Long soNbr, Short regionCode,
	...
	public static class IUserBillCycle0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycle0102Id() {
		}

		/** full constructor */
		public IUserBillCycle0102Id(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycle0102Id) ) return false;
			IUserBillCycle0102Id castOther = (IUserBillCycle0102Id) other;
