...
/**
 * IUserBillCycle0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_BILL_CYCLE_0103", schema = "ZG")
@IdClass(IUserBillCycle0103.IUserBillCycle0103Id.class)
public class IUserBillCycle0103 extends IUserBillCycle implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycle0103() {
	}

	/** minimal constructor */
	public IUserBillCycle0103(Long servId, Long soNbr, Short regionCode,
	...
	public static class IUserBillCycle0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycle0103Id() {
		}

		/** full constructor */
		public IUserBillCycle0103Id(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycle0103Id) ) return false;
			IUserBillCycle0103Id castOther = (IUserBillCycle0103Id) other;
