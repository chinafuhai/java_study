...
/**
 * IUserBillCycle0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_BILL_CYCLE_0104", schema = "ZG")
@IdClass(IUserBillCycle0104.IUserBillCycle0104Id.class)
public class IUserBillCycle0104 extends IUserBillCycle implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycle0104() {
	}

	/** minimal constructor */
	public IUserBillCycle0104(Long servId, Long soNbr, Short regionCode,
	...
	public static class IUserBillCycle0104Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycle0104Id() {
		}

		/** full constructor */
		public IUserBillCycle0104Id(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycle0104Id) ) return false;
			IUserBillCycle0104Id castOther = (IUserBillCycle0104Id) other;
