...
/**
 * IUserBillCycle0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_BILL_CYCLE_0105", schema = "ZG")
@IdClass(IUserBillCycle0105.IUserBillCycle0105Id.class)
public class IUserBillCycle0105 extends IUserBillCycle implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycle0105() {
	}

	/** minimal constructor */
	public IUserBillCycle0105(Long servId, Long soNbr, Short regionCode,
	...
	public static class IUserBillCycle0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycle0105Id() {
		}

		/** full constructor */
		public IUserBillCycle0105Id(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycle0105Id) ) return false;
			IUserBillCycle0105Id castOther = (IUserBillCycle0105Id) other;
