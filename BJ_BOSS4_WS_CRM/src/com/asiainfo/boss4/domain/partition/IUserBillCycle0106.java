...
/**
 * IUserBillCycle0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_BILL_CYCLE_0106", schema = "ZG")
@IdClass(IUserBillCycle0106.IUserBillCycle0106Id.class)
public class IUserBillCycle0106 extends IUserBillCycle implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycle0106() {
	}

	/** minimal constructor */
	public IUserBillCycle0106(Long servId, Long soNbr, Short regionCode,
	...
	public static class IUserBillCycle0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycle0106Id() {
		}

		/** full constructor */
		public IUserBillCycle0106Id(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycle0106Id) ) return false;
			IUserBillCycle0106Id castOther = (IUserBillCycle0106Id) other;
