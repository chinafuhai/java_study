...
/**
 * IUserBillCycle0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_BILL_CYCLE_0107", schema = "ZG")
@IdClass(IUserBillCycle0107.IUserBillCycle0107Id.class)
public class IUserBillCycle0107 extends IUserBillCycle implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycle0107() {
	}

	/** minimal constructor */
	public IUserBillCycle0107(Long servId, Long soNbr, Short regionCode,
	...
	public static class IUserBillCycle0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycle0107Id() {
		}

		/** full constructor */
		public IUserBillCycle0107Id(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycle0107Id) ) return false;
			IUserBillCycle0107Id castOther = (IUserBillCycle0107Id) other;
