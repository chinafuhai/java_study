...
/**
 * IUserBillCycle0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_BILL_CYCLE_0108", schema = "ZG")
@IdClass(IUserBillCycle0108.IUserBillCycle0108Id.class)
public class IUserBillCycle0108 extends IUserBillCycle implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycle0108() {
	}

	/** minimal constructor */
	public IUserBillCycle0108(Long servId, Long soNbr, Short regionCode,
	...
	public static class IUserBillCycle0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycle0108Id() {
		}

		/** full constructor */
		public IUserBillCycle0108Id(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycle0108Id) ) return false;
			IUserBillCycle0108Id castOther = (IUserBillCycle0108Id) other;
