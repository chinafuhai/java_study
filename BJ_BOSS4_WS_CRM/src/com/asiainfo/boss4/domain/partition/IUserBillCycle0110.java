...
/**
 * IUserBillCycle0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_BILL_CYCLE_0110", schema = "ZG")
@IdClass(IUserBillCycle0110.IUserBillCycle0110Id.class)
public class IUserBillCycle0110 extends IUserBillCycle implements java.io.Serializable {
	...
	/** default constructor */
	public IUserBillCycle0110() {
	}

	/** minimal constructor */
	public IUserBillCycle0110(Long servId, Long soNbr, Short regionCode,
	...
	public static class IUserBillCycle0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserBillCycle0110Id() {
		}

		/** full constructor */
		public IUserBillCycle0110Id(Long servId, Long soNbr) {
			this.servId = servId;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserBillCycle0110Id) ) return false;
			IUserBillCycle0110Id castOther = (IUserBillCycle0110Id) other;
