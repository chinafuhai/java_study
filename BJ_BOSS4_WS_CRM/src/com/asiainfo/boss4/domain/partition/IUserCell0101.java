...
/**
 * IUserCell0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_0101", schema = "ZG")
@IdClass(IUserCell0101.IUserCell0101Id.class)
public class IUserCell0101 extends IUserCell implements java.io.Serializable {
	...
	/** default constructor */
	public IUserCell0101() {
	}

	/** minimal constructor */
	public IUserCell0101(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCell0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCell0101Id() {
		}

		/** full constructor */
		public IUserCell0101Id(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCell0101Id) ) return false;
	        IUserCell0101Id castOther = (IUserCell0101Id) other;
