...
/**
 * IUserCell0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_0102", schema = "ZG")
@IdClass(IUserCell0102.IUserCell0102Id.class)
public class IUserCell0102 extends IUserCell implements java.io.Serializable {
	...
	/** default constructor */
	public IUserCell0102() {
	}

	/** minimal constructor */
	public IUserCell0102(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCell0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCell0102Id() {
		}

		/** full constructor */
		public IUserCell0102Id(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCell0102Id) ) return false;
	        IUserCell0102Id castOther = (IUserCell0102Id) other;
