...
/**
 * IUserCell0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_0103", schema = "ZG")
@IdClass(IUserCell0103.IUserCell0103Id.class)
public class IUserCell0103 extends IUserCell implements java.io.Serializable {
	...
	/** default constructor */
	public IUserCell0103() {
	}

	/** minimal constructor */
	public IUserCell0103(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCell0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCell0103Id() {
		}

		/** full constructor */
		public IUserCell0103Id(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCell0103Id) ) return false;
	        IUserCell0103Id castOther = (IUserCell0103Id) other;
