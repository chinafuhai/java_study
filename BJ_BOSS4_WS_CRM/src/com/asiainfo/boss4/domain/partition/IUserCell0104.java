...
/**
 * IUserCell0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_0104", schema = "ZG")
@IdClass(IUserCell0104.IUserCell0104Id.class)
@PartitionNameForTable
@PartitionNameForTable.RegionCode
public class IUserCell0104 extends IUserCell implements java.io.Serializable {
	...
	/** default constructor */
	public IUserCell0104() {
	}

	/** minimal constructor */
	public IUserCell0104(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCell0104Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCell0104Id() {
		}

		/** full constructor */
		public IUserCell0104Id(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCell0104Id) ) return false;
	        IUserCell0104Id castOther = (IUserCell0104Id) other;
