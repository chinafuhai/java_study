...
/**
 * IUserCell0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_0105", schema = "ZG")
@IdClass(IUserCell0105.IUserCell0105Id.class)
@PartitionNameForTable
@PartitionNameForTable.RegionCode
public class IUserCell0105 extends IUserCell implements java.io.Serializable {
	...
	/** default constructor */
	public IUserCell0105() {
	}

	/** minimal constructor */
	public IUserCell0105(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCell0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCell0105Id() {
		}

		/** full constructor */
		public IUserCell0105Id(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCell0105Id) ) return false;
	        IUserCell0105Id castOther = (IUserCell0105Id) other;
