...
/**
 * IUserCell0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_0106", schema = "ZG")
@IdClass(IUserCell0106.IUserCell0106Id.class)
public class IUserCell0106 extends IUserCell implements java.io.Serializable {
	...
	/** default constructor */
	public IUserCell0106() {
	}

	/** minimal constructor */
	public IUserCell0106(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCell0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCell0106Id() {
		}

		/** full constructor */
		public IUserCell0106Id(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCell0106Id) ) return false;
	        IUserCell0106Id castOther = (IUserCell0106Id) other;
