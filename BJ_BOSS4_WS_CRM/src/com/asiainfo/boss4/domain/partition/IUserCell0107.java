...
/**
 * IUserCell0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_0107", schema = "ZG")
@IdClass(IUserCell0107.IUserCell0107Id.class)
public class IUserCell0107 extends IUserCell implements java.io.Serializable {
	...
	/** default constructor */
	public IUserCell0107() {
	}

	/** minimal constructor */
	public IUserCell0107(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCell0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCell0107Id() {
		}

		/** full constructor */
		public IUserCell0107Id(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCell0107Id) ) return false;
	        IUserCell0107Id castOther = (IUserCell0107Id) other;
