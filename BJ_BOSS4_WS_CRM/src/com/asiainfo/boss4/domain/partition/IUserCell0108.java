...
/**
 * IUserCell0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_0108", schema = "ZG")
@IdClass(IUserCell0108.IUserCell0108Id.class)
public class IUserCell0108 extends IUserCell implements java.io.Serializable {
	...
	/** default constructor */
	public IUserCell0108() {
	}

	/** minimal constructor */
	public IUserCell0108(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCell0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCell0108Id() {
		}

		/** full constructor */
		public IUserCell0108Id(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCell0108Id) ) return false;
	        IUserCell0108Id castOther = (IUserCell0108Id) other;
