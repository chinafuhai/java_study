...
/**
 * IUserCell0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_CELL_0109", schema = "ZG")
@IdClass(IUserCell0109.IUserCell0109Id.class)
public class IUserCell0109 extends IUserCell implements java.io.Serializable {
	...
	/** default constructor */
	public IUserCell0109() {
	}

	/** minimal constructor */
	public IUserCell0109(Long servId, Integer spromId, Date validDate, Long soId,
	...
	public static class IUserCell0109Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserCell0109Id() {
		}

		/** full constructor */
		public IUserCell0109Id(Long servId, Date validDate, Long soId) {
			this.servId = servId;
			this.validDate = validDate;
			this.soId = soId;
		}
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserCell0109Id) ) return false;
	        IUserCell0109Id castOther = (IUserCell0109Id) other;
