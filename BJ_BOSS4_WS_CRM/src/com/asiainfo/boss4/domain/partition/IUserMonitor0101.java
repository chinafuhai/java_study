...
/**
 * IUserMonitor0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR_0101", schema = "ZG")
@IdClass(IUserMonitor0101.IUserMonitor0101Id.class)
public class IUserMonitor0101 extends IUserMonitor implements java.io.Serializable {
	...
	/** default constructor */
	public IUserMonitor0101() {
	}

	/** minimal constructor */
	public IUserMonitor0101(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitor0101Id implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitor0101Id() {
		}
	
		/** full constructor */
		public IUserMonitor0101Id(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitor0101Id) ) return false;
			IUserMonitor0101Id castOther = (IUserMonitor0101Id) other;
