...
/**
 * IUserMonitor0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR_0102", schema = "ZG")
@IdClass(IUserMonitor0102.IUserMonitor0102Id.class)
public class IUserMonitor0102 extends IUserMonitor implements java.io.Serializable {
	...
	/** default constructor */
	public IUserMonitor0102() {
	}

	/** minimal constructor */
	public IUserMonitor0102(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitor0102Id implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitor0102Id() {
		}
	
		/** full constructor */
		public IUserMonitor0102Id(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitor0102Id) ) return false;
			IUserMonitor0102Id castOther = (IUserMonitor0102Id) other;
