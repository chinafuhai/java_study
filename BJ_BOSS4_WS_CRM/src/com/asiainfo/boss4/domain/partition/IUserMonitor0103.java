...
/**
 * IUserMonitor0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR_0103", schema = "ZG")
@IdClass(IUserMonitor0103.IUserMonitor0103Id.class)
public class IUserMonitor0103 extends IUserMonitor implements java.io.Serializable {
	...
	/** default constructor */
	public IUserMonitor0103() {
	}

	/** minimal constructor */
	public IUserMonitor0103(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitor0103Id implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitor0103Id() {
		}
	
		/** full constructor */
		public IUserMonitor0103Id(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitor0103Id) ) return false;
			IUserMonitor0103Id castOther = (IUserMonitor0103Id) other;
