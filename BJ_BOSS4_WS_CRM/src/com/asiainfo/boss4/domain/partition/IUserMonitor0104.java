...
/**
 * IUserMonitor0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR_0104", schema = "ZG")
@IdClass(IUserMonitor0104.IUserMonitor0104Id.class)
public class IUserMonitor0104 extends IUserMonitor implements java.io.Serializable {
	...
	/** default constructor */
	public IUserMonitor0104() {
	}

	/** minimal constructor */
	public IUserMonitor0104(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitor0104Id implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitor0104Id() {
		}
	
		/** full constructor */
		public IUserMonitor0104Id(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitor0104Id) ) return false;
			IUserMonitor0104Id castOther = (IUserMonitor0104Id) other;
