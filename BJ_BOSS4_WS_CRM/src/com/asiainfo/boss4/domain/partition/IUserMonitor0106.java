...
/**
 * IUserMonitor0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR_0106", schema = "ZG")
@IdClass(IUserMonitor0106.IUserMonitor0106Id.class)
public class IUserMonitor0106 extends IUserMonitor implements java.io.Serializable {
	...
	/** default constructor */
	public IUserMonitor0106() {
	}

	/** minimal constructor */
	public IUserMonitor0106(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitor0106Id implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitor0106Id() {
		}
	
		/** full constructor */
		public IUserMonitor0106Id(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitor0106Id) ) return false;
			IUserMonitor0106Id castOther = (IUserMonitor0106Id) other;
