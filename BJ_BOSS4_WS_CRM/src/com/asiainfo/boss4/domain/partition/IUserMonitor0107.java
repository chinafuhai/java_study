...
/**
 * IUserMonitor0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR_0107", schema = "ZG")
@IdClass(IUserMonitor0107.IUserMonitor0107Id.class)
public class IUserMonitor0107 extends IUserMonitor implements java.io.Serializable {
	...
	/** default constructor */
	public IUserMonitor0107() {
	}

	/** minimal constructor */
	public IUserMonitor0107(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitor0107Id implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitor0107Id() {
		}
	
		/** full constructor */
		public IUserMonitor0107Id(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitor0107Id) ) return false;
			IUserMonitor0107Id castOther = (IUserMonitor0107Id) other;
