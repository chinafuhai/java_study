...
/**
 * IUserMonitor0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR_0108", schema = "ZG")
@IdClass(IUserMonitor0108.IUserMonitor0108Id.class)
public class IUserMonitor0108 extends IUserMonitor implements java.io.Serializable {
	...
	/** default constructor */
	public IUserMonitor0108() {
	}

	/** minimal constructor */
	public IUserMonitor0108(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitor0108Id implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitor0108Id() {
		}
	
		/** full constructor */
		public IUserMonitor0108Id(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitor0108Id) ) return false;
			IUserMonitor0108Id castOther = (IUserMonitor0108Id) other;
