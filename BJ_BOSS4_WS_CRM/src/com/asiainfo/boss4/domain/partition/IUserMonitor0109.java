...
/**
 * IUserMonitor0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR_0109", schema = "ZG")
@IdClass(IUserMonitor0109.IUserMonitor0109Id.class)
public class IUserMonitor0109 extends IUserMonitor implements java.io.Serializable {
	...
	/** default constructor */
	public IUserMonitor0109() {
	}

	/** minimal constructor */
	public IUserMonitor0109(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitor0109Id implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitor0109Id() {
		}
	
		/** full constructor */
		public IUserMonitor0109Id(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitor0109Id) ) return false;
			IUserMonitor0109Id castOther = (IUserMonitor0109Id) other;
