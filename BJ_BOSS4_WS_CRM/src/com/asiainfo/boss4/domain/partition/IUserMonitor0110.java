...
/**
 * IUserMonitor0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MONITOR_0110", schema = "ZG")
@IdClass(IUserMonitor0110.IUserMonitor0110Id.class)
public class IUserMonitor0110 extends IUserMonitor implements java.io.Serializable {
	...
	/** default constructor */
	public IUserMonitor0110() {
	}

	/** minimal constructor */
	public IUserMonitor0110(Long servId, Date validDate, Integer monitorFlag,
	...
	public static class IUserMonitor0110Id implements java.io.Serializable {
		...
		// Constructors
		/** default constructor */
		public IUserMonitor0110Id() {
		}
	
		/** full constructor */
		public IUserMonitor0110Id(Long servId, Date validDate, Integer monitorFlag,
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserMonitor0110Id) ) return false;
			IUserMonitor0110Id castOther = (IUserMonitor0110Id) other;
