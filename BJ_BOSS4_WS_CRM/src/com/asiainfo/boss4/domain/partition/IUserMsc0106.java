...
/**
 * IUserMsc0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_MSC_0106", schema = "ZG")
@IdClass(IUserMsc0106.IUserMsc0106Id.class)
public class IUserMsc0106 extends IUserMsc implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserMsc0106(Long servId, Integer prodId, Integer busiType,
	...
	public static class IUserMsc0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserMsc0106Id() {
		}

		/** full constructor */
		public IUserMsc0106Id(Long servId, Integer prodId, Integer busiType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserMsc0106Id) ) return false;
	        IUserMsc0106Id castOther = (IUserMsc0106Id) other;
