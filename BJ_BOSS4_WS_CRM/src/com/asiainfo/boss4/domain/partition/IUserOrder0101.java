...
/**
 * IUserOrder0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_ORDER_0101", schema = "ZG")
@IdClass(IUserOrder0101.IUserOrder0101Id.class)
public class IUserOrder0101 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrder0101() {
	}

	/** minimal constructor */
	public IUserOrder0101(Long sid, Long servId, Integer busiType,
