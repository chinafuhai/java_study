...
/**
 * IUserOrder0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_ORDER_0107", schema = "ZG")
@IdClass(IUserOrder0107.IUserOrder0107Id.class)
public class IUserOrder0107 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrder0107() {
	}

	/** minimal constructor */
	public IUserOrder0107(Long sid, Long servId, Integer busiType,
