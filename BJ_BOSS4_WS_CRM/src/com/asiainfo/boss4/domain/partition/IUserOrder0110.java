...
/**
 * IUserOrder0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_ORDER_0110", schema = "ZG")
@IdClass(IUserOrder0110.IUserOrder0110Id.class)
public class IUserOrder0110 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrder0110() {
	}

	/** minimal constructor */
	public IUserOrder0110(Long sid, Long servId, Integer busiType,
