...
@Table(name = "I_USER_ORDER_DELAY_0101", schema = "INTER")
@IdClass(IUserOrderDelay0101.IUserOrder0101Id.class)
public class IUserOrderDelay0101 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0101() {
	}

	/** minimal constructor */
	public IUserOrderDelay0101(Long sid, Long servId, Integer busiType,
	...
	public static class IUserOrder0101Id implements java.io.Serializable {
		// Fields
		...
		/** default constructor */
		public IUserOrder0101Id() {
		}

		/** full constructor */
		public IUserOrder0101Id(Long sid, Long servId, Integer servType, String spCode, String operatorCode, String thirdMsisdn) {
			this.sid = sid;
			this.servId = servId;
			this.servType = servType;
			this.spCode = spCode;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserOrder0101Id))
				return false;
			IUserOrder0101Id castOther = (IUserOrder0101Id) other;
