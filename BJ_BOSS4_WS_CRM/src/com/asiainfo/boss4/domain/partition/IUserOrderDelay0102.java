...
@Table(name = "I_USER_ORDER_DELAY_0102", schema = "INTER")
@IdClass(IUserOrderDelay0102.IUserOrder0102Id.class)
public class IUserOrderDelay0102 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0102() {
	}

	/** minimal constructor */
	public IUserOrderDelay0102(Long sid, Long servId, Integer busiType,
	...
	public static class IUserOrder0102Id implements java.io.Serializable {
		// Fields
		...
		/** default constructor */
		public IUserOrder0102Id() {
		}

		/** full constructor */
		public IUserOrder0102Id(Long sid, Long servId, Integer servType, String spCode, String operatorCode, String thirdMsisdn) {
			this.sid = sid;
			this.servId = servId;
			this.servType = servType;
			this.spCode = spCode;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserOrder0102Id))
				return false;
			IUserOrder0102Id castOther = (IUserOrder0102Id) other;
