...
@Table(name = "I_USER_ORDER_DELAY_0103", schema = "INTER")
@IdClass(IUserOrderDelay0103.IUserOrder0103Id.class)
public class IUserOrderDelay0103 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0103() {
	}

	/** minimal constructor */
	public IUserOrderDelay0103(Long sid, Long servId, Integer busiType,
	...
	public static class IUserOrder0103Id implements java.io.Serializable {
		// Fields
		...
		/** default constructor */
		public IUserOrder0103Id() {
		}

		/** full constructor */
		public IUserOrder0103Id(Long sid, Long servId, Integer servType, String spCode, String operatorCode, String thirdMsisdn) {
			this.sid = sid;
			this.servId = servId;
			this.servType = servType;
			this.spCode = spCode;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserOrder0103Id))
				return false;
			IUserOrder0103Id castOther = (IUserOrder0103Id) other;
