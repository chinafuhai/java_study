...
@Table(name = "I_USER_ORDER_DELAY_0104", schema = "INTER")
@IdClass(IUserOrderDelay0104.IUserOrder0104Id.class)
public class IUserOrderDelay0104 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0104() {
	}

	/** minimal constructor */
	public IUserOrderDelay0104(Long sid, Long servId, Integer busiType,
	...
	public static class IUserOrder0104Id implements java.io.Serializable {
		// Fields
		...
		/** default constructor */
		public IUserOrder0104Id() {
		}

		/** full constructor */
		public IUserOrder0104Id(Long sid, Long servId, Integer servType, String spCode, String operatorCode, String thirdMsisdn) {
			this.sid = sid;
			this.servId = servId;
			this.servType = servType;
			this.spCode = spCode;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserOrder0104Id))
				return false;
			IUserOrder0104Id castOther = (IUserOrder0104Id) other;
