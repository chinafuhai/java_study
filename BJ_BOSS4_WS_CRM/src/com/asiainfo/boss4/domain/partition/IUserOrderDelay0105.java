...
@Table(name = "I_USER_ORDER_DELAY_0105", schema = "INTER")
@IdClass(IUserOrderDelay0105.IUserOrder0105Id.class)
public class IUserOrderDelay0105 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0105() {
	}

	/** minimal constructor */
	public IUserOrderDelay0105(Long sid, Long servId, Integer busiType,
	...
	public static class IUserOrder0105Id implements java.io.Serializable {
		// Fields
		...
		/** default constructor */
		public IUserOrder0105Id() {
		}

		/** full constructor */
		public IUserOrder0105Id(Long sid, Long servId, Integer servType, String spCode, String operatorCode, String thirdMsisdn) {
			this.sid = sid;
			this.servId = servId;
			this.servType = servType;
			this.spCode = spCode;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserOrder0105Id))
				return false;
			IUserOrder0105Id castOther = (IUserOrder0105Id) other;
