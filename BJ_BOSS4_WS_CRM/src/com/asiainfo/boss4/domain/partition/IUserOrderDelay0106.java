...
/**
 * IUserOrder0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_ORDER_DELAY_0106", schema = "INTER")
@IdClass(IUserOrderDelay0106.IUserOrder0106Id.class)
public class IUserOrderDelay0106 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0106() {
	}

	/** minimal constructor */
	public IUserOrderDelay0106(Long sid, Long servId, Integer busiType,
	...
	public static class IUserOrder0106Id implements java.io.Serializable {
		// Fields
		...
		/** default constructor */
		public IUserOrder0106Id() {
		}

		/** full constructor */
		public IUserOrder0106Id(Long sid, Long servId, Integer servType, String spCode, String operatorCode, String thirdMsisdn) {
			this.sid = sid;
			this.servId = servId;
			this.servType = servType;
			this.spCode = spCode;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserOrder0106Id))
				return false;
			IUserOrder0106Id castOther = (IUserOrder0106Id) other;
