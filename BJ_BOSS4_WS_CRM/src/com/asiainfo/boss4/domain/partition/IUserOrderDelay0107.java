...
@Table(name = "I_USER_ORDER_DELAY_0107", schema = "INTER")
@IdClass(IUserOrderDelay0107.IUserOrder0107Id.class)
public class IUserOrderDelay0107 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0107() {
	}

	/** minimal constructor */
	public IUserOrderDelay0107(Long sid, Long servId, Integer busiType,
	...
	public static class IUserOrder0107Id implements java.io.Serializable {
		// Fields
		...
		/** default constructor */
		public IUserOrder0107Id() {
		}

		/** full constructor */
		public IUserOrder0107Id(Long sid, Long servId, Integer servType, String spCode, String operatorCode, String thirdMsisdn) {
			this.sid = sid;
			this.servId = servId;
			this.servType = servType;
			this.spCode = spCode;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserOrder0107Id))
				return false;
			IUserOrder0107Id castOther = (IUserOrder0107Id) other;
