...
@Table(name = "I_USER_ORDER_DELAY_0108", schema = "INTER")
@IdClass(IUserOrderDelay0108.IUserOrder0108Id.class)
public class IUserOrderDelay0108 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0108() {
	}

	/** minimal constructor */
	public IUserOrderDelay0108(Long sid, Long servId, Integer busiType,
	...
	public static class IUserOrder0108Id implements java.io.Serializable {
		// Fields
		...
		/** default constructor */
		public IUserOrder0108Id() {
		}

		/** full constructor */
		public IUserOrder0108Id(Long sid, Long servId, Integer servType, String spCode, String operatorCode, String thirdMsisdn) {
			this.sid = sid;
			this.servId = servId;
			this.servType = servType;
			this.spCode = spCode;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserOrder0108Id))
				return false;
			IUserOrder0108Id castOther = (IUserOrder0108Id) other;
