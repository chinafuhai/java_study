...
@Table(name = "I_USER_ORDER_DELAY_0109", schema = "INTER")
@IdClass(IUserOrderDelay0109.IUserOrder0109Id.class)
public class IUserOrderDelay0109 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0109() {
	}

	/** minimal constructor */
	public IUserOrderDelay0109(Long sid, Long servId, Integer busiType,
