...
@Table(name = "I_USER_ORDER_DELAY_0110", schema = "INTER")
@IdClass(IUserOrderDelay0110.IUserOrder0110Id.class)
public class IUserOrderDelay0110 extends IUserOrder implements java.io.Serializable {
	...
	/** default constructor */
	public IUserOrderDelay0110() {
	}

	/** minimal constructor */
	public IUserOrderDelay0110(Long sid, Long servId, Integer busiType,
	...
	public static class IUserOrder0110Id implements java.io.Serializable {
		// Fields
		...
		/** default constructor */
		public IUserOrder0110Id() {
		}

		/** full constructor */
		public IUserOrder0110Id(Long sid, Long servId, Integer servType, String spCode, String operatorCode, String thirdMsisdn) {
			this.sid = sid;
			this.servId = servId;
			this.servType = servType;
			this.spCode = spCode;
		...
		public boolean equals(Object other) {
			if (!(other instanceof IUserOrder0110Id))
				return false;
			IUserOrder0110Id castOther = (IUserOrder0110Id) other;
