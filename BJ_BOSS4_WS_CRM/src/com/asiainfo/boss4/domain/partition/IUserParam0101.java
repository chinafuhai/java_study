...
/**
 * IUserParam0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PARAM_0101", schema = "ZG")
@IdClass(IUserParam0101.IUserParam0101Id.class)
public class IUserParam0101 extends IUserParam implements java.io.Serializable {
        ...
        /** default constructor */
        public IUserParam0101() {
        }

        /** minimal constructor */
        public IUserParam0101(Long servId, Date validDate, Date expireDate, Long sid,
                        Long soNbr) {
                this.servId = servId;
        ...
        /** full constructor */
        public IUserParam0101(Long servId, Integer keyId,
        ...
        public static class IUserParam0101Id implements java.io.Serializable {
                ...
                /** default constructor */
                public IUserParam0101Id() {
                }

                /** full constructor */
                public IUserParam0101Id(Long servId, Integer keyId, Date validDate) {
                        this.servId = servId;
                        this.keyId = keyId;
                        this.validDate = validDate;
                }
                ...
                public boolean equals(Object other) {
                   if ( !(other instanceof IUserParam0101Id) ) return false;
                   IUserParam0101Id castOther = (IUserParam0101Id) other;
