...
/**
 * IUserParam0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PARAM_0104", schema = "ZG")
@IdClass(IUserParam0104.IUserParam0104Id.class)
public class IUserParam0104 extends IUserParam implements java.io.Serializable {
        ...
        /** default constructor */
        public IUserParam0104() {
        }

        /** minimal constructor */
        public IUserParam0104(Long servId, Date validDate, Date expireDate, Long sid,
                        Long soNbr) {
                this.servId = servId;
        ...
        /** full constructor */
        public IUserParam0104(Long servId, Integer keyId,
        ...
        public static class IUserParam0104Id implements java.io.Serializable {
                ...
                /** default constructor */
                public IUserParam0104Id() {
                }

                /** full constructor */
                public IUserParam0104Id(Long servId, Integer keyId, Date validDate) {
                        this.servId = servId;
                        this.keyId = keyId;
                        this.validDate = validDate;
                }
                ...
                public boolean equals(Object other) {
                   if ( !(other instanceof IUserParam0104Id) ) return false;
                   IUserParam0104Id castOther = (IUserParam0104Id) other;
