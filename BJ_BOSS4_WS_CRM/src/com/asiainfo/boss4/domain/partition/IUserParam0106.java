...
/**
 * IUserParam0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PARAM_0106", schema = "ZG")
@IdClass(IUserParam0106.IUserParam0106Id.class)
public class IUserParam0106 extends IUserParam implements java.io.Serializable {
        ...
        /** default constructor */
        public IUserParam0106() {
        }

        /** minimal constructor */
        public IUserParam0106(Long servId, Date validDate, Date expireDate, Long sid,
                        Long soNbr) {
                this.servId = servId;
        ...
        /** full constructor */
        public IUserParam0106(Long servId, Integer keyId,
        ...
        public static class IUserParam0106Id implements java.io.Serializable {
                ...
                /** default constructor */
                public IUserParam0106Id() {
                }

                /** full constructor */
                public IUserParam0106Id(Long servId, Integer keyId, Date validDate) {
                        this.servId = servId;
                        this.keyId = keyId;
                        this.validDate = validDate;
                }
                ...
                public boolean equals(Object other) {
                   if ( !(other instanceof IUserParam0106Id) ) return false;
                   IUserParam0106Id castOther = (IUserParam0106Id) other;
