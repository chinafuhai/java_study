...
/**
 * IUserParam0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PARAM_0107", schema = "ZG")
@IdClass(IUserParam0107.IUserParam0107Id.class)
public class IUserParam0107 extends IUserParam implements java.io.Serializable {
        ...
        /** default constructor */
        public IUserParam0107() {
        }

        /** minimal constructor */
        public IUserParam0107(Long servId, Date validDate, Date expireDate, Long sid,
                        Long soNbr) {
                this.servId = servId;
        ...
        /** full constructor */
        public IUserParam0107(Long servId, Integer keyId,
        ...
        public static class IUserParam0107Id implements java.io.Serializable {
                ...
                /** default constructor */
                public IUserParam0107Id() {
                }

                /** full constructor */
                public IUserParam0107Id(Long servId, Integer keyId, Date validDate) {
                        this.servId = servId;
                        this.keyId = keyId;
                        this.validDate = validDate;
                }
                ...
                public boolean equals(Object other) {
                   if ( !(other instanceof IUserParam0107Id) ) return false;
                   IUserParam0107Id castOther = (IUserParam0107Id) other;
