...
/**
 * IUserParam0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PARAM_0108", schema = "ZG")
@IdClass(IUserParam0108.IUserParam0108Id.class)
public class IUserParam0108 extends IUserParam implements java.io.Serializable {
        ...
        /** default constructor */
        public IUserParam0108() {
        }

        /** minimal constructor */
        public IUserParam0108(Long servId, Date validDate, Date expireDate, Long sid,
                        Long soNbr) {
                this.servId = servId;
        ...
        /** full constructor */
        public IUserParam0108(Long servId, Integer keyId,
        ...
        public static class IUserParam0108Id implements java.io.Serializable {
                ...
                /** default constructor */
                public IUserParam0108Id() {
                }

                /** full constructor */
                public IUserParam0108Id(Long servId, Integer keyId, Date validDate) {
                        this.servId = servId;
                        this.keyId = keyId;
                        this.validDate = validDate;
                }
                ...
                public boolean equals(Object other) {
                   if ( !(other instanceof IUserParam0108Id) ) return false;
                   IUserParam0108Id castOther = (IUserParam0108Id) other;
