...
/**
 * IUserParam0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PARAM_0109", schema = "ZG")
@IdClass(IUserParam0109.IUserParam0109Id.class)
public class IUserParam0109 extends IUserParam implements java.io.Serializable {
        ...
        /** default constructor */
        public IUserParam0109() {
        }

        /** minimal constructor */
        public IUserParam0109(Long servId, Date validDate, Date expireDate, Long sid,
                        Long soNbr) {
                this.servId = servId;
        ...
        /** full constructor */
        public IUserParam0109(Long servId, Integer keyId,
        ...
        public static class IUserParam0109Id implements java.io.Serializable {
                ...
                /** default constructor */
                public IUserParam0109Id() {
                }

                /** full constructor */
                public IUserParam0109Id(Long servId, Integer keyId, Date validDate) {
                        this.servId = servId;
                        this.keyId = keyId;
                        this.validDate = validDate;
                }
                ...
                public boolean equals(Object other) {
                   if ( !(other instanceof IUserParam0109Id) ) return false;
                   IUserParam0109Id castOther = (IUserParam0109Id) other;
