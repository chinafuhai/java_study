...
/**
 * IUserPbx0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PBX_0102", schema = "ZG")
@IdClass(IUserPbx0102.IUserPbx0102Id.class)
public class IUserPbx0102 extends IUserPbx implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserPbx0102(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, String inTrunk,
	...
	/** full constructor */
	public IUserPbx0102(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, Short areaCode,
	...
	public static class IUserPbx0102Id implements java.io.Serializable {
		private Long servId;
		private Long mscId;
		private Date validDate;
		private Long soNbr;
		...
		/** default constructor */
		public IUserPbx0102Id() {
		}

		/** full constructor */
		public IUserPbx0102Id(Long servId, Long mscId, Date validDate, Long soNbr,String inTrunk) {
			this.servId = servId;
			this.mscId = mscId;
			this.validDate = validDate;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserPbx0102Id) ) return false;
			IUserPbx0102Id castOther = (IUserPbx0102Id) other;
