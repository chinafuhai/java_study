...
/**
 * IUserPbx0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PBX_0103", schema = "ZG")
@IdClass(IUserPbx0103.IUserPbx0103Id.class)
public class IUserPbx0103 extends IUserPbx implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserPbx0103(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, String inTrunk,
	...
	/** full constructor */
	public IUserPbx0103(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, Short areaCode,
	...
	public static class IUserPbx0103Id implements java.io.Serializable {
		private Long servId;
		private Long mscId;
		private Date validDate;
		private Long soNbr;
		...
		/** default constructor */
		public IUserPbx0103Id() {
		}

		/** full constructor */
		public IUserPbx0103Id(Long servId, Long mscId, Date validDate, Long soNbr,String inTrunk) {
			this.servId = servId;
			this.mscId = mscId;
			this.validDate = validDate;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserPbx0103Id) ) return false;
			IUserPbx0103Id castOther = (IUserPbx0103Id) other;
