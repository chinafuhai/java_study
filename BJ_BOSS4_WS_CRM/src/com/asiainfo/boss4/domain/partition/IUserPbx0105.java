...
/**
 * IUserPbx0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PBX_0105", schema = "ZG")
@IdClass(IUserPbx0105.IUserPbx0105Id.class)
public class IUserPbx0105 extends IUserPbx implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserPbx0105(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, String inTrunk,
	...
	/** full constructor */
	public IUserPbx0105(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, Short areaCode,
	...
	public static class IUserPbx0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserPbx0105Id() {
		}

		/** full constructor */
		public IUserPbx0105Id(Long servId, Long mscId, Date validDate, Long soNbr,String inTrunk) {
			this.servId = servId;
			this.mscId = mscId;
			this.validDate = validDate;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserPbx0105Id) ) return false;
			IUserPbx0105Id castOther = (IUserPbx0105Id) other;
