...
/**
 * IUserPbx0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PBX_0106", schema = "ZG")
@IdClass(IUserPbx0106.IUserPbx0106Id.class)
public class IUserPbx0106 extends IUserPbx implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserPbx0106(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, String inTrunk,
	...
	/** full constructor */
	public IUserPbx0106(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, Short areaCode,
	...
	public static class IUserPbx0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserPbx0106Id() {
		}

		/** full constructor */
		public IUserPbx0106Id(Long servId, Long mscId, Date validDate, Long soNbr,String inTrunk) {
			this.servId = servId;
			this.mscId = mscId;
			this.validDate = validDate;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserPbx0106Id) ) return false;
			IUserPbx0106Id castOther = (IUserPbx0106Id) other;
