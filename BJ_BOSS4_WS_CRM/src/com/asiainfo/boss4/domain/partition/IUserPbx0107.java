...
/**
 * IUserPbx0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PBX_0107", schema = "ZG")
@IdClass(IUserPbx0107.IUserPbx0107Id.class)
public class IUserPbx0107 extends IUserPbx implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserPbx0107(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, String inTrunk,
	...
	/** full constructor */
	public IUserPbx0107(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, Short areaCode,
	...
	public static class IUserPbx0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserPbx0107Id() {
		}

		/** full constructor */
		public IUserPbx0107Id(Long servId, Long mscId, Date validDate, Long soNbr,String inTrunk) {
			this.servId = servId;
			this.mscId = mscId;
			this.validDate = validDate;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserPbx0107Id) ) return false;
			IUserPbx0107Id castOther = (IUserPbx0107Id) other;
