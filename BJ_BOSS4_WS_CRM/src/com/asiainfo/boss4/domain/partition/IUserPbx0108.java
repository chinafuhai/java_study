...
/**
 * IUserPbx0108 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PBX_0108", schema = "ZG")
@IdClass(IUserPbx0108.IUserPbx0108Id.class)
public class IUserPbx0108 extends IUserPbx implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserPbx0108(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, String inTrunk,
	...
	/** full constructor */
	public IUserPbx0108(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, Short areaCode,
	...
	public static class IUserPbx0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserPbx0108Id() {
		}

		/** full constructor */
		public IUserPbx0108Id(Long servId, Long mscId, Date validDate, Long soNbr,String inTrunk) {
			this.servId = servId;
			this.mscId = mscId;
			this.validDate = validDate;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserPbx0108Id) ) return false;
			IUserPbx0108Id castOther = (IUserPbx0108Id) other;
