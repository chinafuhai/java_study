...
/**
 * IUserPbx0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PBX_0109", schema = "ZG")
@IdClass(IUserPbx0109.IUserPbx0109Id.class)
public class IUserPbx0109 extends IUserPbx implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserPbx0109(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, String inTrunk,
	...
	/** full constructor */
	public IUserPbx0109(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, Short areaCode,
	...
	public static class IUserPbx0109Id implements java.io.Serializable {
		private Long servId;
		private Long mscId;
		private Date validDate;
		private Long soNbr;
		...
		/** default constructor */
		public IUserPbx0109Id() {
		}

		/** full constructor */
		public IUserPbx0109Id(Long servId, Long mscId, Date validDate, Long soNbr,String inTrunk) {
			this.servId = servId;
			this.mscId = mscId;
			this.validDate = validDate;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserPbx0109Id) ) return false;
			IUserPbx0109Id castOther = (IUserPbx0109Id) other;
