...
/**
 * IUserPbx0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_PBX_0110", schema = "ZG")
@IdClass(IUserPbx0110.IUserPbx0110Id.class)
public class IUserPbx0110 extends IUserPbx implements java.io.Serializable {
	...
	/** minimal constructor */
	public IUserPbx0110(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, String inTrunk,
	...
	/** full constructor */
	public IUserPbx0110(Long servId, Long mscId, Date validDate, Long soNbr, Short regionCode, Short areaCode,
	...
	public static class IUserPbx0110Id implements java.io.Serializable {
		private Long servId;
		private Long mscId;
		private Date validDate;
		private Long soNbr;
		...
		/** default constructor */
		public IUserPbx0110Id() {
		}

		/** full constructor */
		public IUserPbx0110Id(Long servId, Long mscId, Date validDate, Long soNbr,String inTrunk) {
			this.servId = servId;
			this.mscId = mscId;
			this.validDate = validDate;
			this.soNbr = soNbr;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserPbx0110Id) ) return false;
			IUserPbx0110Id castOther = (IUserPbx0110Id) other;
