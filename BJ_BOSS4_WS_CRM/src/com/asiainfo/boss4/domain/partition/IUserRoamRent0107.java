...
/**
 * IUserRoamRent0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_ROAM_RENT_0107", schema = "ZG")
@IdClass(IUserRoamRent0107.IUserRoamRent0107Id.class)
public class IUserRoamRent0107 extends IUserRoamRent implements java.io.Serializable {
	...
	/** default constructor */
	public IUserRoamRent0107() {
	}

	/** minimal constructor */
	public IUserRoamRent0107(Long servId, String roamMsisdn, Date validDate, String msisdn, Integer rentId,
	...
	public static class IUserRoamRent0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserRoamRent0107Id() {
		}

		/** full constructor */
		public IUserRoamRent0107Id(Long servId, String roamMsisdn, Date validDate) {
			this.servId = servId;
			this.roamMsisdn = roamMsisdn;
			this.validDate = validDate;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserRoamRent0107Id) ) return false;
			IUserRoamRent0107Id castOther = (IUserRoamRent0107Id) other;
