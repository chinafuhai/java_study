...
/**
 * IUserShareSprom01010105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SHARE_SPROM_0101", schema = "ZG")
@IdClass(IUserShareSprom0101.IUserShareSprom0101Id.class)
public class IUserShareSprom0101 extends IUserShareSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserShareSprom0101() {
	}

	/** minimal constructor */
	public IUserShareSprom0101(Long servId, Long groupId, Integer spromId,
	...
	public static class IUserShareSprom0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserShareSprom0101Id() {
		}

		/** full constructor */
		public IUserShareSprom0101Id(Long servId, Long groupId, Integer spromId,
				Long soId, Integer serviceId) {
			this.servId = servId;
			this.groupId = groupId;
			this.spromId = spromId;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserShareSprom0101Id) ) return false;
			IUserShareSprom0101Id castOther = (IUserShareSprom0101Id) other;
