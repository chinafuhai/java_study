...
/**
 * IUserShareSprom01020105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SHARE_SPROM_0102", schema = "ZG")
@IdClass(IUserShareSprom0102.IUserShareSprom0102Id.class)
public class IUserShareSprom0102 extends IUserShareSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserShareSprom0102() {
	}

	/** minimal constructor */
	public IUserShareSprom0102(Long servId, Long groupId, Integer spromId,
	...
	public static class IUserShareSprom0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserShareSprom0102Id() {
		}

		/** full constructor */
		public IUserShareSprom0102Id(Long servId, Long groupId, Integer spromId,
				Long soId, Integer serviceId) {
			this.servId = servId;
			this.groupId = groupId;
			this.spromId = spromId;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserShareSprom0102Id) ) return false;
			IUserShareSprom0102Id castOther = (IUserShareSprom0102Id) other;
