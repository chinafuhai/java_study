...
/**
 * IUserShareSprom01030105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SHARE_SPROM_0103", schema = "ZG")
@IdClass(IUserShareSprom0103.IUserShareSprom0103Id.class)
public class IUserShareSprom0103 extends IUserShareSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserShareSprom0103() {
	}

	/** minimal constructor */
	public IUserShareSprom0103(Long servId, Long groupId, Integer spromId,
	...
	public static class IUserShareSprom0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserShareSprom0103Id() {
		}

		/** full constructor */
		public IUserShareSprom0103Id(Long servId, Long groupId, Integer spromId,
				Long soId, Integer serviceId) {
			this.servId = servId;
			this.groupId = groupId;
			this.spromId = spromId;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserShareSprom0103Id) ) return false;
			IUserShareSprom0103Id castOther = (IUserShareSprom0103Id) other;
