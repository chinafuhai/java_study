...
/**
 * IUserShareSprom01040105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SHARE_SPROM_0104", schema = "ZG")
@IdClass(IUserShareSprom0104.IUserShareSprom0104Id.class)
public class IUserShareSprom0104 extends IUserShareSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserShareSprom0104() {
	}

	/** minimal constructor */
	public IUserShareSprom0104(Long servId, Long groupId, Integer spromId,
	...
	public static class IUserShareSprom0104Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserShareSprom0104Id() {
		}

		/** full constructor */
		public IUserShareSprom0104Id(Long servId, Long groupId, Integer spromId,
				Long soId, Integer serviceId) {
			this.servId = servId;
			this.groupId = groupId;
			this.spromId = spromId;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserShareSprom0104Id) ) return false;
			IUserShareSprom0104Id castOther = (IUserShareSprom0104Id) other;
