...
/**
 * IUserShareSprom01050105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SHARE_SPROM_0105", schema = "ZG")
@IdClass(IUserShareSprom0105.IUserShareSprom0105Id.class)
public class IUserShareSprom0105 extends IUserShareSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserShareSprom0105() {
	}

	/** minimal constructor */
	public IUserShareSprom0105(Long servId, Long groupId, Integer spromId,
	...
	public static class IUserShareSprom0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserShareSprom0105Id() {
		}

		/** full constructor */
		public IUserShareSprom0105Id(Long servId, Long groupId, Integer spromId,
				Long soId, Integer serviceId) {
			this.servId = servId;
			this.groupId = groupId;
			this.spromId = spromId;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserShareSprom0105Id) ) return false;
			IUserShareSprom0105Id castOther = (IUserShareSprom0105Id) other;
