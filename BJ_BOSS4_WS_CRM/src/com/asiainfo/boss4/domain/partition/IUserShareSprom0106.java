...
/**
 * IUserShareSprom01060105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SHARE_SPROM_0106", schema = "ZG")
@IdClass(IUserShareSprom0106.IUserShareSprom0106Id.class)
public class IUserShareSprom0106 extends IUserShareSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserShareSprom0106() {
	}

	/** minimal constructor */
	public IUserShareSprom0106(Long servId, Long groupId, Integer spromId,
	...
	public static class IUserShareSprom0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserShareSprom0106Id() {
		}

		/** full constructor */
		public IUserShareSprom0106Id(Long servId, Long groupId, Integer spromId,
				Long soId, Integer serviceId) {
			this.servId = servId;
			this.groupId = groupId;
			this.spromId = spromId;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserShareSprom0106Id) ) return false;
			IUserShareSprom0106Id castOther = (IUserShareSprom0106Id) other;
