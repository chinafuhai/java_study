...
/**
 * IUserShareSprom01070105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SHARE_SPROM_0107", schema = "ZG")
@IdClass(IUserShareSprom0107.IUserShareSprom0107Id.class)
public class IUserShareSprom0107 extends IUserShareSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserShareSprom0107() {
	}

	/** minimal constructor */
	public IUserShareSprom0107(Long servId, Long groupId, Integer spromId,
	...
	public static class IUserShareSprom0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserShareSprom0107Id() {
		}

		/** full constructor */
		public IUserShareSprom0107Id(Long servId, Long groupId, Integer spromId,
				Long soId, Integer serviceId) {
			this.servId = servId;
			this.groupId = groupId;
			this.spromId = spromId;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserShareSprom0107Id) ) return false;
			IUserShareSprom0107Id castOther = (IUserShareSprom0107Id) other;
