...
/**
 * IUserShareSprom01080105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SHARE_SPROM_0108", schema = "ZG")
@IdClass(IUserShareSprom0108.IUserShareSprom0108Id.class)
public class IUserShareSprom0108 extends IUserShareSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserShareSprom0108() {
	}

	/** minimal constructor */
	public IUserShareSprom0108(Long servId, Long groupId, Integer spromId,
	...
	public static class IUserShareSprom0108Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserShareSprom0108Id() {
		}

		/** full constructor */
		public IUserShareSprom0108Id(Long servId, Long groupId, Integer spromId,
				Long soId, Integer serviceId) {
			this.servId = servId;
			this.groupId = groupId;
			this.spromId = spromId;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserShareSprom0108Id) ) return false;
			IUserShareSprom0108Id castOther = (IUserShareSprom0108Id) other;
