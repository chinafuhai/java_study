...
/**
 * IUserShareSprom01100105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SHARE_SPROM_0110", schema = "ZG")
@IdClass(IUserShareSprom0110.IUserShareSprom0110Id.class)
public class IUserShareSprom0110 extends IUserShareSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserShareSprom0110() {
	}

	/** minimal constructor */
	public IUserShareSprom0110(Long servId, Long groupId, Integer spromId,
	...
	public static class IUserShareSprom0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserShareSprom0110Id() {
		}

		/** full constructor */
		public IUserShareSprom0110Id(Long servId, Long groupId, Integer spromId,
				Long soId, Integer serviceId) {
			this.servId = servId;
			this.groupId = groupId;
			this.spromId = spromId;
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserShareSprom0110Id) ) return false;
			IUserShareSprom0110Id castOther = (IUserShareSprom0110Id) other;
