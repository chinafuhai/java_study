...
/**
 * IUserSprom0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SPROM_0101", schema = "ZG")
@IdClass(IUserSprom0101.IUserSprom0101Id.class)
public class IUserSprom0101 extends IUserSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserSprom0101() {
	}

	/** minimal constructor */
	public IUserSprom0101(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSprom0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSprom0101Id() {
		}

		/** full constructor */
		public IUserSprom0101Id(Long servId, Integer spromId, Byte operType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSprom0101Id) ) return false;
	        IUserSprom0101Id castOther = (IUserSprom0101Id) other;
