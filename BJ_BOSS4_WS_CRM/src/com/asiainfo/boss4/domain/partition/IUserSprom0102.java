...
/**
 * IUserSprom0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SPROM_0102", schema = "ZG")
@IdClass(IUserSprom0102.IUserSprom0102Id.class)
public class IUserSprom0102 extends IUserSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserSprom0102() {
	}

	/** minimal constructor */
	public IUserSprom0102(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSprom0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSprom0102Id() {
		}

		/** full constructor */
		public IUserSprom0102Id(Long servId, Integer spromId, Byte operType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSprom0102Id) ) return false;
	        IUserSprom0102Id castOther = (IUserSprom0102Id) other;
