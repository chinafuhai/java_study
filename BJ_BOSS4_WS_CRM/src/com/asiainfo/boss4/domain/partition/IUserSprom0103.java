...
/**
 * IUserSprom0103 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SPROM_0103", schema = "ZG")
@IdClass(IUserSprom0103.IUserSprom0103Id.class)
public class IUserSprom0103 extends IUserSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserSprom0103() {
	}

	/** minimal constructor */
	public IUserSprom0103(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSprom0103Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSprom0103Id() {
		}

		/** full constructor */
		public IUserSprom0103Id(Long servId, Integer spromId, Byte operType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSprom0103Id) ) return false;
	        IUserSprom0103Id castOther = (IUserSprom0103Id) other;
