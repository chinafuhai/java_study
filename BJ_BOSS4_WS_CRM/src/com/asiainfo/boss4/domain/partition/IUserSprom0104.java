...
/**
 * IUserSprom0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SPROM_0104", schema = "ZG")
@IdClass(IUserSprom0104.IUserSprom0104Id.class)
public class IUserSprom0104 extends IUserSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserSprom0104() {
	}

	/** minimal constructor */
	public IUserSprom0104(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSprom0104Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSprom0104Id() {
		}

		/** full constructor */
		public IUserSprom0104Id(Long servId, Integer spromId, Byte operType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSprom0104Id) ) return false;
	        IUserSprom0104Id castOther = (IUserSprom0104Id) other;
