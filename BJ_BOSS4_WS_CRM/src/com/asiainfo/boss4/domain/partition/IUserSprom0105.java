...
/**
 * IUserSprom0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SPROM_0105", schema = "ZG")
@IdClass(IUserSprom0105.IUserSprom0105Id.class)
public class IUserSprom0105 extends IUserSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserSprom0105() {
	}

	/** minimal constructor */
	public IUserSprom0105(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSprom0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSprom0105Id() {
		}

		/** full constructor */
		public IUserSprom0105Id(Long servId, Integer spromId, Byte operType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSprom0105Id) ) return false;
	        IUserSprom0105Id castOther = (IUserSprom0105Id) other;
