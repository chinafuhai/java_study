...
/**
 * IUserSprom0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SPROM_0106", schema = "ZG")
@IdClass(IUserSprom0106.IUserSprom0106Id.class)
public class IUserSprom0106 extends IUserSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserSprom0106() {
	}

	/** minimal constructor */
	public IUserSprom0106(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSprom0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSprom0106Id() {
		}

		/** full constructor */
		public IUserSprom0106Id(Long servId, Integer spromId, Byte operType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSprom0106Id) ) return false;
	        IUserSprom0106Id castOther = (IUserSprom0106Id) other;
