...
/**
 * IUserSprom0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SPROM_0107", schema = "ZG")
@IdClass(IUserSprom0107.IUserSprom0107Id.class)
public class IUserSprom0107 extends IUserSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserSprom0107() {
	}

	/** minimal constructor */
	public IUserSprom0107(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSprom0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSprom0107Id() {
		}

		/** full constructor */
		public IUserSprom0107Id(Long servId, Integer spromId, Byte operType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSprom0107Id) ) return false;
	        IUserSprom0107Id castOther = (IUserSprom0107Id) other;
