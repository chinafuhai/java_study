...
/**
 * IUserSprom0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SPROM_0109", schema = "ZG")
@IdClass(IUserSprom0109.IUserSprom0109Id.class)
public class IUserSprom0109 extends IUserSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserSprom0109() {
	}

	/** minimal constructor */
	public IUserSprom0109(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSprom0109Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSprom0109Id() {
		}

		/** full constructor */
		public IUserSprom0109Id(Long servId, Integer spromId, Byte operType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSprom0109Id) ) return false;
	        IUserSprom0109Id castOther = (IUserSprom0109Id) other;
