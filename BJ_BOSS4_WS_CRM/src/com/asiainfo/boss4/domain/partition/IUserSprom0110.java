...
/**
 * IUserSprom0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_SPROM_0110", schema = "ZG")
@IdClass(IUserSprom0110.IUserSprom0110Id.class)
public class IUserSprom0110 extends IUserSprom implements java.io.Serializable {
	...
	/** default constructor */
	public IUserSprom0110() {
	}

	/** minimal constructor */
	public IUserSprom0110(Long servId, Integer spromId, Byte operType,
	...
	public static class IUserSprom0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserSprom0110Id() {
		}

		/** full constructor */
		public IUserSprom0110Id(Long servId, Integer spromId, Byte operType,
		...
		public boolean equals(Object other) {
	        if ( !(other instanceof IUserSprom0110Id) ) return false;
	        IUserSprom0110Id castOther = (IUserSprom0110Id) other;
