...
/**
 * IUserStatus0101 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_0101", schema = "ZG")
@IdClass(IUserStatus0101.IUserStatus0101Id.class)
public class IUserStatus0101 extends IUserStatus implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatus0101() {
	}

	/** minimal constructor */
	public IUserStatus0101(Long servId, Long sid, Long soNbr, Byte userSts, Short userType,
	...
	/** full constructor */
	public IUserStatus0101(Long servId, Long sid, Long soNbr, Byte userSts, Byte operSts,
	...
	public static class IUserStatus0101Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserStatus0101Id() {
		}

		/** full constructor */
		public IUserStatus0101Id(Long servId, Long sid, Long soNbr) {
			this.servId = servId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserStatus0101Id) ) return false;
			IUserStatus0101Id castOther = (IUserStatus0101Id) other;
