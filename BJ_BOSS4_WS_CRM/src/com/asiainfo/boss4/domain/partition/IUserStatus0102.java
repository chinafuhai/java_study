...
/**
 * IUserStatus0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_0102", schema = "ZG")
@IdClass(IUserStatus0102.IUserStatus0102Id.class)
public class IUserStatus0102 extends IUserStatus implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatus0102() {
	}

	/** minimal constructor */
	public IUserStatus0102(Long servId, Long sid, Long soNbr, Byte userSts, Short userType,
	...
	/** full constructor */
	public IUserStatus0102(Long servId, Long sid, Long soNbr, Byte userSts, Byte operSts,
	...
	public static class IUserStatus0102Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserStatus0102Id() {
		}

		/** full constructor */
		public IUserStatus0102Id(Long servId, Long sid, Long soNbr) {
			this.servId = servId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserStatus0102Id) ) return false;
			IUserStatus0102Id castOther = (IUserStatus0102Id) other;
