...
/**
 * IUserStatus0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_0105", schema = "ZG")
@IdClass(IUserStatus0105.IUserStatus0105Id.class)
public class IUserStatus0105 extends IUserStatus implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatus0105() {
	}

	/** minimal constructor */
	public IUserStatus0105(Long servId, Long sid, Long soNbr, Byte userSts, Short userType,
	...
	/** full constructor */
	public IUserStatus0105(Long servId, Long sid, Long soNbr, Byte userSts, Byte operSts,
	...
	public static class IUserStatus0105Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserStatus0105Id() {
		}

		/** full constructor */
		public IUserStatus0105Id(Long servId, Long sid, Long soNbr) {
			this.servId = servId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserStatus0105Id) ) return false;
			IUserStatus0105Id castOther = (IUserStatus0105Id) other;
