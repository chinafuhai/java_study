...
/**
 * IUserStatus0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_0106", schema = "ZG")
@IdClass(IUserStatus0106.IUserStatus0106Id.class)
public class IUserStatus0106 extends IUserStatus implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatus0106() {
	}

	/** minimal constructor */
	public IUserStatus0106(Long servId, Long sid, Long soNbr, Byte userSts, Short userType,
	...
	/** full constructor */
	public IUserStatus0106(Long servId, Long sid, Long soNbr, Byte userSts, Byte operSts,
	...
	public static class IUserStatus0106Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserStatus0106Id() {
		}

		/** full constructor */
		public IUserStatus0106Id(Long servId, Long sid, Long soNbr) {
			this.servId = servId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserStatus0106Id) ) return false;
			IUserStatus0106Id castOther = (IUserStatus0106Id) other;
