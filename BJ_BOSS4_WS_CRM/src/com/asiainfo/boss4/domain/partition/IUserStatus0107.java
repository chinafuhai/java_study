...
/**
 * IUserStatus0107 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_0107", schema = "ZG")
@IdClass(IUserStatus0107.IUserStatus0107Id.class)
public class IUserStatus0107 extends IUserStatus implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatus0107() {
	}

	/** minimal constructor */
	public IUserStatus0107(Long servId, Long sid, Long soNbr, Byte userSts, Short userType,
	...
	/** full constructor */
	public IUserStatus0107(Long servId, Long sid, Long soNbr, Byte userSts, Byte operSts,
	...
	public static class IUserStatus0107Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserStatus0107Id() {
		}

		/** full constructor */
		public IUserStatus0107Id(Long servId, Long sid, Long soNbr) {
			this.servId = servId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserStatus0107Id) ) return false;
			IUserStatus0107Id castOther = (IUserStatus0107Id) other;
