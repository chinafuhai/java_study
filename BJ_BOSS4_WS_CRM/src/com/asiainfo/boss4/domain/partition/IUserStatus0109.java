...
/**
 * IUserStatus0109 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_0109", schema = "ZG")
@IdClass(IUserStatus0109.IUserStatus0109Id.class)
public class IUserStatus0109 extends IUserStatus implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatus0109() {
	}

	/** minimal constructor */
	public IUserStatus0109(Long servId, Long sid, Long soNbr, Byte userSts, Short userType,
	...
	/** full constructor */
	public IUserStatus0109(Long servId, Long sid, Long soNbr, Byte userSts, Byte operSts,
	...
	public static class IUserStatus0109Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserStatus0109Id() {
		}

		/** full constructor */
		public IUserStatus0109Id(Long servId, Long sid, Long soNbr) {
			this.servId = servId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserStatus0109Id) ) return false;
			IUserStatus0109Id castOther = (IUserStatus0109Id) other;
