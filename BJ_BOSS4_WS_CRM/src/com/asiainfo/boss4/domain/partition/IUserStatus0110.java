...
/**
 * IUserStatus0110 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_0110", schema = "ZG")
@IdClass(IUserStatus0110.IUserStatus0110Id.class)
public class IUserStatus0110 extends IUserStatus implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatus0110() {
	}

	/** minimal constructor */
	public IUserStatus0110(Long servId, Long sid, Long soNbr, Byte userSts, Short userType,
	...
	/** full constructor */
	public IUserStatus0110(Long servId, Long sid, Long soNbr, Byte userSts, Byte operSts,
	...
	public static class IUserStatus0110Id implements java.io.Serializable {
		...
		/** default constructor */
		public IUserStatus0110Id() {
		}

		/** full constructor */
		public IUserStatus0110Id(Long servId, Long sid, Long soNbr) {
			this.servId = servId;
			this.sid = sid;
			this.soNbr = soNbr;
		}
		...
		public boolean equals(Object other) {
			if ( !(other instanceof IUserStatus0110Id) ) return false;
			IUserStatus0110Id castOther = (IUserStatus0110Id) other;
