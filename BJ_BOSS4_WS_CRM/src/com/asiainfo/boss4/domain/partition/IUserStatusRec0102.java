...
/**
 * IUserStatusRec0102 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_REC_0102", schema = "ZG")
public class IUserStatusRec0102 extends IUserStatusRec implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatusRec0102() {
	}

	/** minimal constructor */
	public IUserStatusRec0102(Long servId, Date commitDate) {
		this.servId = servId;
		this.commitDate = commitDate;
	}

	/** full constructor */
	public IUserStatusRec0102(Long servId, Byte mgntSts, String remark, Date commitDate) {
		this.servId = servId;
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IUserStatusRec0102) ) return false;
		IUserStatusRec0102 castOther = (IUserStatusRec0102) other;
