...
/**
 * IUserStatusRec0104 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_REC_0104", schema = "ZG")
public class IUserStatusRec0104 extends IUserStatusRec implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatusRec0104() {
	}

	/** minimal constructor */
	public IUserStatusRec0104(Long servId, Date commitDate) {
		this.servId = servId;
		this.commitDate = commitDate;
	}

	/** full constructor */
	public IUserStatusRec0104(Long servId, Byte mgntSts, String remark, Date commitDate) {
		this.servId = servId;
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IUserStatusRec0104) ) return false;
		IUserStatusRec0104 castOther = (IUserStatusRec0104) other;
