...
/**
 * IUserStatusRec0105 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_REC_0105", schema = "ZG")
public class IUserStatusRec0105 extends IUserStatusRec implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatusRec0105() {
	}

	/** minimal constructor */
	public IUserStatusRec0105(Long servId, Date commitDate) {
		this.servId = servId;
		this.commitDate = commitDate;
	}

	/** full constructor */
	public IUserStatusRec0105(Long servId, Byte mgntSts, String remark, Date commitDate) {
		this.servId = servId;
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IUserStatusRec0105) ) return false;
		IUserStatusRec0105 castOther = (IUserStatusRec0105) other;
