...
/**
 * IUserStatusRec0106 entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicUpdate=true)
@Table(name = "I_USER_STATUS_REC_0106", schema = "ZG")
public class IUserStatusRec0106 extends IUserStatusRec implements java.io.Serializable {
	...
	/** default constructor */
	public IUserStatusRec0106() {
	}

	/** minimal constructor */
	public IUserStatusRec0106(Long servId, Date commitDate) {
		this.servId = servId;
		this.commitDate = commitDate;
	}

	/** full constructor */
	public IUserStatusRec0106(Long servId, Byte mgntSts, String remark, Date commitDate) {
		this.servId = servId;
	...
	public boolean equals(Object other) {
		if ( !(other instanceof IUserStatusRec0106) ) return false;
		IUserStatusRec0106 castOther = (IUserStatusRec0106) other;
