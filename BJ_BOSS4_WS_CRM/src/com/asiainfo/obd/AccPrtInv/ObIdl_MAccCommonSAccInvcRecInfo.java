...
public class ObIdl_MAccCommonSAccInvcRecInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://AccPrtInv/", "ObIdl_MAccCommon.SAccInvcRecInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://AccPrtInv/", "ObIdl_MAccCommon.SAccInvcRecDtl"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
