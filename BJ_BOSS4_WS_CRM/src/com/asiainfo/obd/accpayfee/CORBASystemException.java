...
public class CORBASystemException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private com.asiainfo.obd.accpayfee.CORBACompletion_status completion_status;
    ...
    public CORBASystemException(
           ...
           com.asiainfo.obd.accpayfee.CORBACompletion_status completion_status) {
        this.minor = minor;
     ...
     */
    public com.asiainfo.obd.accpayfee.CORBACompletion_status getCompletion_status() {
        return completion_status;
    }
     ...
     */
    public void setCompletion_status(com.asiainfo.obd.accpayfee.CORBACompletion_status completion_status) {
        this.completion_status = completion_status;
    }
