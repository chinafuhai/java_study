...
public class CrmCustomerTestCase {
	...
	@Test
	public void testQueryByCA() {
		CrmCustomer load = CrmCustomer.queryByCa(context, "CA:SC5CSZPE");
		System.out.println(load);
		Assert.assertEquals(new Long(50839870), load.getCustId());
	}
